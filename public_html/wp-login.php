 ...
 *
 * @param string $title
 *        	Optional. WordPress login Page title to display in the `<title>` element.
 *        	Default 'Log In'.
...
function retrieve_password() {
	 ...
	 *        	A WP_Error object containing any errors generated
...
<form name="resetpassform" id="resetpassform"
	...
	<div class="user-pass1-wrap">
		...
		<div class="wp-pwd">
			<span class="password-input-wrapper"> <input type="password"
				...
				name="pass1" id="pass1" class="input" size="20" value=""
	...
	<p class="user-pass2-wrap">
		...
		<input type="password" name="pass2" id="pass2" class="input" size="20"
...
<form name="registerform" id="registerform"
	...
	<p>
		<label for="user_email"><?php _e('Email') ?><br /> <input type="email"
...
<form name="loginform" id="loginform"
	...
	<p>
		<label for="user_login"><?php _e( 'Username or Email Address' ); ?><br />
			...
			<?php echo $aria_describedby_error; ?> class="input"
			value="<?php echo esc_attr( $user_login ); ?>" size="20" /></label>
	</p>
	<p>
	...
	<p class="forgetmenot">
		<label for="rememberme"><input name="rememberme" type="checkbox"
			id="rememberme" value="forever" <?php checked( $rememberme ); ?> /> <?php esc_html_e( 'Remember Me' ); ?></label>
	</p>
	<p class="submit">
		<input type="submit" name="wp-submit" id="wp-submit"
			class="button button-primary button-large"
