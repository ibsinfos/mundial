	...
	?>
		...
		<tr class="form-field form-required user-pass1-wrap">
				...
				<td>
					...
					<input type="password" name="admin_password" id="pass1"
							class="regular-text" autocomplete="off" data-reveal="1"
					...
					<p>
						<span class="description important hide-if-no-js"> <strong><?php _e( 'Important:' ); ?></strong>
			...
			<tr class="form-field form-required user-pass2-wrap hide-if-js">
				...
				<td><input name="admin_password2" type="password" id="pass2"
					autocomplete="off" /></td>
			</tr>
			<tr class="pw-weak">
		...
		<tr>
				...
				<td><input name="admin_email" type="email" id="admin_email"
					size="25" value="<?php echo esc_attr( $admin_email ); ?>" />
	...
	if (has_action ( 'blog_privacy_selector' )) {
		?>
						<input id="blog-public" type="radio" name="blog_public" value="1"
							<?php checked( 1, $blog_public ); ?> /> <label for="blog-public"><?php _e( 'Allow search engines to index this site' );?></label><br />
						<input id="blog-norobots" type="radio" name="blog_public"
							value="0" <?php checked( 0, $blog_public ); ?> /> <label
		...
		?>
						<label for="blog_public"><input name="blog_public" type="checkbox"
							id="blog_public" value="0" <?php checked( 0, $blog_public ); ?> />
...
if (! is_string ( $wpdb->base_prefix ) || '' === $wpdb->base_prefix) {
	...
	die ( '<h1>' . __ ( 'Configuration Error' ) . '</h1>' . '<p>' . sprintf(
			...
			__ ( 'Your %s file has an empty database table prefix, which is not supported.' ), '<code>wp-config.php</code>' ) . '</p></body></html>' );
}
...
if (defined ( 'DO_NOT_UPGRADE_GLOBAL_TABLES' )) {
	...
	die ( '<h1>' . __ ( 'Configuration Error' ) . '</h1>' . '<p>' . sprintf(
			...
			__ ( 'The constant %s cannot be defined when installing WordPress.' ), '<code>DO_NOT_UPGRADE_GLOBAL_TABLES</code>' ) . '</p></body></html>' );
}
...
<h1><?php _e( 'Success!' ); ?></h1>
	...
	<table class="form-table install-success">
		...
		<?php endif ?>
			<p><?php echo $result['password_message'] ?></p></td>
		</tr>
	</table>
