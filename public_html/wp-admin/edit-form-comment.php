...
<div class="wrap">
		...
		<div id="poststuff">
			<input type="hidden" name="action" value="editedcomment" /> <input
			...
			<div id="post-body" class="metabox-holder columns-2">
				<div id="post-body-content"
					class="edit-form-section edit-comment-section">
<?php
...
<div class="inside">
						<div id="comment-link-box">
							<strong><?php _ex( 'Permalink:', 'comment' ); ?></strong> <span
								id="sample-permalink"><a href="<?php echo $comment_link; ?>"><?php echo $comment_link; ?></a></span>
						</div>
					</div>
<?php endif; ?>
									...
									<div id="misc-publishing-actions">
										...
										<fieldset class="misc-pub-section misc-pub-comment-status"
											...
											<label><input type="radio"
												...
												name="comment_status" value="1" /><?php _ex( 'Approved', 'comment status' ); ?></label><br />
											<label><input type="radio"
												<?php checked( $comment->comment_approved, '0' ); ?>
												name="comment_status" value="0" /><?php _ex( 'Pending', 'comment status' ); ?></label><br />
											<label><input type="radio"
												<?php checked( $comment->comment_approved, 'spam' ); ?>
												name="comment_status" value="spam" /><?php _ex( 'Spam', 'comment status' ); ?></label>
										</fieldset>
...
printf(
	...
	__ ( 'Submitted on: %s' ), '<b>' . date_i18n ( $datef, strtotime ( $comment->comment_date ) ) . '</b>' );
?></span> <a href="#edit_timestamp" class="edit-timestamp hide-if-no-js"><span
...
printf(
		...
		__ ( 'In response to: %s' ), '<b>' . $post_link . '</b>' );
	?>
</div>
...
printf(
			...
			__ ( 'In reply to: %s' ), '<b><a href="' . $parent_link . '">' . $name . '</a></b>' );
		?>
	</div>
