...
get_current_screen ()->set_help_sidebar ( '<p><strong>' . __ ( 'For more information:' ) . '</strong></p>' . '<p>' . __ ( '<a href="https://codex.wordpress.org/Settings_General_Screen">Documentation on General Settings</a>' ) . '</p>' . '<p>' . __ ( '<a href="https://wordpress.org/support/">Support Forums</a>' ) . '</p>' );
				...
				<td>
					<fieldset>
						...
						<label for="users_can_register"> <input name="users_can_register"
							...
							<?php checked('1', get_option('users_can_register')); ?> />
<?php _e('Anyone can register') ?></label>
			...
			<tr>
				...
				<td><select name="default_role" id="default_role"><?php wp_dropdown_roles( get_option('default_role') ); ?></select>
				</td>
			</tr>
<?php } else { ?>
<tr>
...
<div class="updated inline">
		...
		__ ( 'There is a pending change of the admin email to %s.' ), '<code>' . esc_html ( $new_admin_email ) . '</code>' );
 ...
 *       
 * @param array $default_date_formats
 ...
 * @since 2.7.0
 *       
 * @param array $default_time_formats
 *        	Array of default time formats.
 */
