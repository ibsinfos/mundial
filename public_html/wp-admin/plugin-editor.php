...
<?php endforeach; ?>
	...
	<?php wp_nonce_field('edit-plugin_' . $file)?>
		...
		<div id="documentation" class="hide-if-no-js">
			<label for="docs-list"><?php _e('Documentation:') ?></label> <?php echo $docs_select ?> <input
