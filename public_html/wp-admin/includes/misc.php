...
/**
 * Extracts strings from between the BEGIN and END markers in the .
 * htaccess file.
 *
 * @since 1.5.0
 *       
...
function wp_doc_link_parse($content) {
	 ...
	 * @since 2.8.0
	 *       
	 * @param array $ignore_functions
	 *        	Functions and classes to be ignored.
	 */
...
<fieldset id="color-picker" class="scheme-list">
	...
	foreach ( $_wp_admin_css_colors as $color => $color_info ) :
		...
		?>
			<div
		class="color-option <?php echo ( $color == $current_color ) ? 'selected' : ''; ?>">
		<input name="admin_color"
			id="admin_color_<?php echo esc_attr( $color ); ?>" type="radio"
			value="<?php echo esc_attr( $color ); ?>" class="tog"
			<?php checked( $color, $current_color ); ?> /> <input type="hidden"
			class="css_url" value="<?php echo esc_url( $color_info->url ); ?>" />
...
function wp_color_scheme_settings() {
	...
	echo '<script type="text/javascript">var _wpColorScheme = ' . wp_json_encode ( array (
			'icons' => $icon_colors 
	) ) . ";</script>\n";
}
 ...
 *        	An array of Heartbeat settings.
