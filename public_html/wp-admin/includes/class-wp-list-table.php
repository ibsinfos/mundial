...
class WP_List_Table {
	 ...
	 *        
	 * @param string $key
	 *        	Pagination argument to retrieve. Common values include 'total_items',
...
<p class="search-box">
	<label class="screen-reader-text"
		for="<?php echo esc_attr( $input_id ); ?>"><?php echo $text; ?>:</label>
...
<?php
	...
	protected function months_dropdown($post_type) {
		 ...
		 *       
		 * @param object $months
		 *        	The months drop-down query results.
		 * @param string $post_type
		 *        	The post type.
		 */
...
<?php
	...
	protected function comments_bubble($post_id, $pending_comments) {
		...
		if (! $approved_comments && ! $pending_comments) {
			...
			printf ( '<a href="%s" class="post-com-count post-com-count-approved"><span class="comment-count-approved" aria-hidden="true">%s</span><span class="screen-reader-text">%s</span></a>', esc_url ( add_query_arg ( array (
					'p' => $post_id,
					'comment_status' => 'approved' 
			), admin_url ( 'edit-comments.php' ) ) ), $approved_comments_number, $pending_comments ? $approved_phrase : $approved_only_phrase );
		} else {
		...
		if ($pending_comments) {
			printf ( '<a href="%s" class="post-com-count post-com-count-pending"><span class="comment-count-pending" aria-hidden="true">%s</span><span class="screen-reader-text">%s</span></a>', esc_url ( add_query_arg ( array (
					'p' => $post_id,
					'comment_status' => 'moderated' 
			), admin_url ( 'edit-comments.php' ) ) ), $pending_comments_number, $pending_phrase );
		} else {
