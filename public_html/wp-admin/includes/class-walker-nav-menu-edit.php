...
<li id="menu-item-<?php echo $item_id; ?>"
	...
	<div class="menu-item-bar">
		...
		?>"
					...
					aria-label="<?php esc_attr_e( 'Move down' ) ?>">&#8595;</a>
	...
	<div class="menu-item-settings wp-clearfix"
		...
		<p
			class="field-title-attribute field-attr-title description description-wide">
		...
		<p class="field-css-classes description description-thin">
			<label for="edit-menu-item-classes-<?php echo $item_id; ?>">
						<?php _e( 'CSS Classes (optional)' ); ?><br /> <input type="text"
		...
		<fieldset
			...
			<button type="button" class="button-link menus-move menus-move-left"
				data-dir="left"></button>
			<button type="button" class="button-link menus-move menus-move-right"
