...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table {
	...
	public function prepare_items() {
		 ...
		 * @since 2.8.0
		 *       
		 * @param array $nonmenu_tabs
		 *        	The tabs that don't have a menu item on
		 ...
		 *       
		 * @param array $args
		 *        	An array of themes API arguments.
		 */
...
<?php
	...
	public function single_row($theme) {
		 ...
		 *       
		 * @param array $actions
		 *        	An array of theme action hyperlinks. Defaults are
...
<a class="screenshot install-theme-preview"
	...
	src="<?php echo esc_url( $theme->screenshot_url ); ?>" width="150"
	alt="" />
</a>
		...
		<div class="wp-full-overlay-footer">
			<button type="button" class="collapse-sidebar button"
				...
				<span class="collapse-sidebar-arrow"></span> <span
					class="collapse-sidebar-label"><?php _e( 'Collapse' ); ?></span>
			</button>
		</div>
	</div>
...
<div class="install-theme-info"><?php
	...
	<span class="theme-by"><?php printf( __( 'By %s' ), $author ); ?></span>
		...
		src="<?php echo esc_url( $theme->screenshot_url ); ?>" alt="" />
			<?php endif; ?>
