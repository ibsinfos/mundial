 ...
 *        	Optional. Sidebar name. Default empty.
 */
...
<div class="sidebar-name">
	...
	<h2><?php echo esc_html( $sidebar_name ); ?> <span class="spinner"></span>
	</h2>
</div>
<?php
	}
...
<div class="widget-top">
	<div class="widget-title-action">
		...
		<a class="widget-control-edit hide-if-js"
			...
			class="screen-reader-text"><?php echo $widget_title; ?></span>
		</a>
	</div>
	<div class="widget-title">
		<h3><?php echo $widget_title; ?><span class="in-widget-title"></span>
		</h3>
	</div>
</div>
...
<div class="widget-inside">
	...
	<input type="hidden" name="widget_number" class="widget_number"
		...
		value="<?php echo esc_attr($multi_number); ?>" /> <input type="hidden"
		name="add_new" class="add_new"
