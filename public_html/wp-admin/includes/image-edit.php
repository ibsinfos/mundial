 ...
 *        	Optional. Message to display for image editor updates or errors.
 *        	Default false.
 */
			...
			<div class="imgedit-group">
				<div class="imgedit-group-top">
					...
					<button type="button"
						...
						onclick="imageEdit.toggleHelp(this);return false;"
						aria-expanded="false">
						<span class="screen-reader-text"><?php esc_html_e( 'Scale Image Help' ); ?></span>
					</button>
		...
		<div class="imgedit-submit">
						...
						<fieldset class="imgedit-scale">
							...
							<div class="nowrap">
								...
								</label> <span class="imgedit-separator">&times;</span> <label><span
									class="screen-reader-text"><?php _e( 'scale height' ); ?></span>
									<input type="text"
								...
								</label> <span class="imgedit-scale-warn"
									id="imgedit-scale-warn-<?php echo $post_id; ?>">!</span> <input
									id="imgedit-scale-button" type="button"
	...
	<div class="imgedit-group">
				<div class="imgedit-group-top">
					...
					<button type="button"
						...
						onclick="imageEdit.toggleHelp(this);return false;"
						aria-expanded="false">
						<span class="screen-reader-text"><?php esc_html_e( 'Image Crop Help' ); ?></span>
					</button>
		...
		<?php _e('Once you have made your selection, you can adjust it by entering the size in pixels. The minimum selection size is the thumbnail size as set in the Media settings.'); ?></p>
				...
				<fieldset class="imgedit-crop-ratio">
					...
					<div class="nowrap">
						...
						</label> <span class="imgedit-separator">:</span> <label><span
							class="screen-reader-text"><?php _e( 'crop ratio height' ); ?></span>
							<input type="text"
				...
				<fieldset id="imgedit-crop-sel-<?php echo $post_id; ?>"
					...
					<div class="nowrap">
						<label><span class="screen-reader-text"><?php _e( 'selection width' ); ?></span>
							...
							class="screen-reader-text"><?php _e( 'selection height' ); ?></span>
							<input type="text"
	...
	<div class="imgedit-group imgedit-applyto">
				<div class="imgedit-group-top">
					...
					<button type="button"
						...
						onclick="imageEdit.toggleHelp(this);return false;"
						aria-expanded="false">
						<span class="screen-reader-text"><?php esc_html_e( 'Thumbnail Settings Help' ); ?></span>
					</button>
				...
				<div id="imgedit-save-target-<?php echo $post_id; ?>"
					...
					<fieldset>
						<legend>
							<strong><?php _e( 'Apply changes to:' ); ?></strong>
						</legend>

						<label class="imgedit-label"> <input type="radio"
							name="imgedit-target-<?php echo $post_id; ?>" value="all"
							checked="checked" />
		<?php _e('All image sizes'); ?></label> <label class="imgedit-label">
							<input type="radio" name="imgedit-target-<?php echo $post_id; ?>"
							value="thumbnail" />
		<?php _e('Thumbnail'); ?></label> <label class="imgedit-label"> <input
							type="radio" name="imgedit-target-<?php echo $post_id; ?>"
							value="nothumb" />
	...
	<?php } ?>
		...
		<div class="imgedit-menu wp-clearfix">
				<button type="button"
					...
					class="imgedit-crop button disabled" disabled>
					<span class="screen-reader-text"><?php esc_html_e( 'Crop' ); ?></span>
				</button><?php
	...
	if (wp_image_editor_supports ( array (
		...
		?>
			<button type="button" class="imgedit-rleft button"
					...
					<span class="screen-reader-text"><?php esc_html_e( 'Rotate counter-clockwise' ); ?></span>
				</button>
				<button type="button" class="imgedit-rright button"
					onclick="imageEdit.rotate(-90, <?php echo "$post_id, '$nonce'"; ?>, this)">
					<span class="screen-reader-text"><?php esc_html_e( 'Rotate clockwise' ); ?></span>
				</button>
	<?php
		...
		?>
			<button type="button" class="imgedit-rleft button disabled" disabled></button>
				<button type="button" class="imgedit-rright button disabled"
					disabled></button>
	<?php } ?>

			<button type="button"
					onclick="imageEdit.flip(1, <?php echo "$post_id, '$nonce'"; ?>, this)"
					class="imgedit-flipv button">
					<span class="screen-reader-text"><?php esc_html_e( 'Flip vertically' ); ?></span>
				</button>
				<button type="button"
					onclick="imageEdit.flip(2, <?php echo "$post_id, '$nonce'"; ?>, this)"
					class="imgedit-fliph button">
					<span class="screen-reader-text"><?php esc_html_e( 'Flip horizontally' ); ?></span>
				</button>

				<button type="button" id="image-undo-<?php echo $post_id; ?>"
					onclick="imageEdit.undo(<?php echo "$post_id, '$nonce'"; ?>, this)"
					class="imgedit-undo button disabled" disabled>
					<span class="screen-reader-text"><?php esc_html_e( 'Undo' ); ?></span>
				</button>
				<button type="button" id="image-redo-<?php echo $post_id; ?>"
					onclick="imageEdit.redo(<?php echo "$post_id, '$nonce'"; ?>, this)"
					class="imgedit-redo button disabled" disabled>
					<span class="screen-reader-text"><?php esc_html_e( 'Redo' ); ?></span>
				</button>
			...
			<input type="hidden" id="imgedit-sizer-<?php echo $post_id; ?>"
				...
				id="imgedit-history-<?php echo $post_id; ?>" value="" /> <input
				type="hidden" id="imgedit-undone-<?php echo $post_id; ?>" value="0" />
			...
			<div class="imgedit-submit">
				<input type="button"
					...
					class="button imgedit-cancel-btn"
					value="<?php esc_attr_e( 'Cancel' ); ?>" /> <input type="button"
					onclick="imageEdit.save(<?php echo "$post_id, '$nonce'"; ?>)"
					disabled="disabled"
					class="button button-primary imgedit-submit-btn"
