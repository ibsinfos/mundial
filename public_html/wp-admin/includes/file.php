 ...
 *        	Optional. Filename to base the Unique file off. Default empty.
 * @param string $dir
 *        	Optional. Directory to store the file in. Default empty.
 ...
 *
 * @param array $file
 *        	Reference to a single element of `$_FILES`. Call the function once for
 *        	each uploaded file.
 * @param array|bool $overrides
...
function _unzip_file_ziparchive($file, $to, $needed_dirs = array()) {
	...
	if (true !== $zopen)
		return new WP_Error ( 'incompatible_archive', __ ( 'Incompatible Archive.' ), array (
 ...
 *        	Optional. Connection args, These are passed directly to
 *        	the `WP_Filesystem_*()` classes. Default false.
 * @param string|false $context
 *        	Optional. Context for get_filesystem_method(). Default false.
 * @param bool $allow_relaxed_file_ownership
 *        	Optional. Whether to allow Group/World writable. Default false.
 ...
 *        
 * @param array $args
 *        	Optional. Connection details. Default empty array.
 * @param string $context
 *        	Optional. Full path to the directory that is tested
 ...
 * @param string $type
 *        	Optional. Chosen type of filesystem. Default empty.
 * @param bool $error
 *        	Optional. Whether the current request has failed to connect.
 *        	Default false.
 * @param string $context
 *        	Optional. Full path to the directory that is tested for being
 *        	writable. Default empty.
 * @param array $extra_fields
 *        	Optional. Extra `POST` fields to be checked for inclusion in
...
function request_filesystem_credentials($form_post, $type = '', $error = false, $context = '', $extra_fields = null, $allow_relaxed_file_ownership = false) {
	 ...
	 *       
	 * @param mixed $output
	 *        	Form output to return instead. Default empty.
	 * @param string $form_post
	 *        	The URL to post the form to.
	 * @param string $type
	 ...
	 *        	Default false.
	 * @param string $context
	 *        	Full path to the directory that is tested for
	 *        	being writable.
	 * @param bool $allow_relaxed_file_ownership
	 *        	Whether to allow Group/World writable.
	 *        	Default false.
	 ...
	 *        	Error object.
	 * @param string $context
	 *        	Full path to the directory that is tested
	 *        	for being writable.
	 */
...
<form action="<?php echo esc_url( $form_post ) ?>" method="post">
	<div id="request-filesystem-credentials-form"
...
<p id="request-filesystem-credentials-desc"><?php
	...
	?></p>
		<label for="hostname"> <span class="field-title"><?php _e( 'Hostname' ) ?></span>
			<input name="hostname" type="text" id="hostname"
			aria-describedby="request-filesystem-credentials-desc" class="code"
		...
		<div class="ftp-username">
			<label for="username"> <span class="field-title"><?php echo $label_user; ?></span>
		...
		<div class="ftp-password">
			<label for="password"> <span class="field-title"><?php echo $label_pass; ?></span>
				<input name="password" type="password" id="password"
				value="<?php if ( defined('FTP_PASS') ) echo '*****'; ?>"
				<?php disabled( defined('FTP_PASS') ); ?> /> <em><?php if ( ! defined('FTP_PASS') ) _e( 'This password will not be stored on the server.' ); ?></em>
			</label>
		</div>
		<fieldset>
...
<?php
	...
	<label for="<?php echo esc_attr( $name ) ?>"> <input type="radio"
				...
				<?php checked( $name, $connection_type ); echo $disabled; ?> />
		<?php echo $text; ?>
	</label>
<?php
	endforeach
...
<fieldset id="ssh-keys"<?php echo $hidden_class; ?>">
			...
			<label for="public_key"> <span class="field-title"><?php _e('Public Key:') ?></span>
				<input name="public_key" type="text" id="public_key"
				aria-describedby="auth-keys-desc"
				value="<?php echo esc_attr($public_key) ?>"
				<?php disabled( defined('FTP_PUBKEY') ); ?> />
			</label> <label for="private_key"> <span class="field-title"><?php _e('Private Key:') ?></span>
...
<div id="request-filesystem-credentials-dialog"
	...
	<div class="notification-dialog" role="dialog"
		aria-labelledby="request-filesystem-credentials-title" tabindex="0">
