...
class WP_Plugin_Install_List_Table extends WP_List_Table {
	...
	public function prepare_items() {
		 ...
		 *       
		 * @param array $tabs
		 *        	The tabs shown on the Plugin Install screen. Defaults include 'featured', 'popular',
...
<?php
	...
	public function display_rows() {
		...
		foreach ( ( array ) $this->items as $plugin ) {
			...
			?>
<div
	class="plugin-card plugin-card-<?php echo sanitize_html_class( $plugin['slug'] ); ?>">
			...
			<h3>
				<a href="<?php echo esc_url( $details_link ); ?>"
					class="thickbox open-plugin-details-modal">
						<?php echo $title; ?>
						<img src="<?php echo esc_attr( $plugin_icon_url ) ?>"
