...
<input type="checkbox" name="linkcheck[]"
...
<?php
	...
	public function column_name($link) {
		...
		printf ( '<strong><a class="row-title" href="%s" aria-label="%s">%s</a></strong>', $edit_link,
			/* translators: %s: link name */
			esc_attr ( sprintf ( __ ( 'Edit &#8220;%s&#8221;' ), $link->link_name ) ), $link->link_name );
	}
