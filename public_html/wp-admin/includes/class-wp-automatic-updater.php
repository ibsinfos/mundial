...
class WP_Automatic_Updater {
	 ...
	 *        
	 * @param string $type
	 *        	The type of update being checked: 'core', 'theme',
	 *        	'plugin', 'translation'.
	 * @param object $item
	 *        	The update offer.
	 * @param string $context
	 *        	The filesystem context (a path) against which filesystem
	...
	protected function send_core_update_notification_email($item) {
		 ...
		 *       
		 * @param bool $notify
		 *        	Whether the site administrator is notified.
		 * @param object $item
		 *        	The update offer.
		 */
	...
	public function update($type, $item) {
		 ...
		 *        	The update offer.
		 * @param string $context
		 *        	The filesystem context (a path) against which filesystem access and status
		 *        	should be checked.
		 */
	...
	public function run() {
		...
		if (! empty ( $this->update_results )) {
			 ...
			 *        	By default, emails are sent if the
	 ...
	 * @param mixed $result
	 *        	Optional. The result for the core update. Can be WP_Error.
	 */
	protected function send_email($type, $core_update, $result = null) {
		 ...
		 * @param string $type
		 *        	The type of email to send. Can be one of
	...
	protected function send_debug_email() {
		...
		foreach ( array (
			...
			if (! isset ( $this->update_results [$type] ))
				continue;
			$success_items = wp_list_filter ( $this->update_results [$type], array (
					'result' => true 
			) );
			if ($success_items) {
				$messages = array (
