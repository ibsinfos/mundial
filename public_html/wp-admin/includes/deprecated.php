 ...
 *        	Optional. Whether to exclude zeroes. Default true.
 ...
 * @param string $type
 *        	Optional. Post type to retrieve. Accepts 'draft', 'pending' or 'any' (all).
 *        	Default 'any'.
 ...
 * as they disregard the autocomplete setting on the editor textarea.
 * That can break the editor
