...
class WP_Upgrader {
	 ...
	 *        	The upgrader skin to use. Default is a WP_Upgrader_Skin.
	 *        	instance.
	 */
	 ...
	 *        	Optional. A list of directories. If any of these do
	 ...
	 *        	The URI of the package. If this is the full path to an
	 ...
	 *        	Optional. Whether to delete the package file after attempting
...
;
		...
		if (! $options ['is_multi']) {
			 ...
			 *       
			 * @param WP_Upgrader $this
			 *        	WP_Upgrader instance. In other contexts, $this, might be a
	 ...
	 *        	Optional. The duration in seconds to respect an existing lock.
	 *        	Default: 1 hour.
