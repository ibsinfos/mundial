...
class WP_MS_Themes_List_Table extends WP_List_Table {
	...
	public function prepare_items() {
		...
		$themes = array (
				 ...
				 *       
				 * @param array $all
				 *        	An array of WP_Theme objects to display in the list table.
				 */
				...
				'disabled' => array (),
				'upgrade' => array (),
				'broken' => $this->is_site_themes ? array () : wp_get_themes ( array (
						'errors' => true 
				) ) 
		);
		...
		if (empty ( $themes [$status] ) && ! in_array ( $status, array (
				'all',
				'search' 
		) ))
			$status = 'all';
...
<?php
	...
	public function column_description($theme) {
		 ...
		 *        	An array of the theme's metadata,
