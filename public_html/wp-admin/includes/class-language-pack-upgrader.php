...
class Language_Pack_Upgrader extends WP_Upgrader {
	 ...
	 *        	Optional. WP_Upgrader instance or false. If `$upgrader` is
	 ...
	 *        	Optional. Whether an update offer is available. Default false.
	 * @param array $args
	 *        	Optional. Other optional arguments, see
	 ...
	 *        
	 * @param array $language_updates
	 *        	Optional. Language pack updates. Default empty array.
	 * @param array $args
	 *        	{
	...
	/**
	 * Check the package source to make sure there are .
	 * mo and .po files.
	 *
	...
	public function check_package($source, $remote_source) {
		...
		if (! $mo || ! $po) {
			return new WP_Error ( 'incompatible_archive_pomo', $this->strings ['incompatible_archive'],
				...
				sprintf ( __ ( 'The language pack is missing either the %1$s or %2$s files.' ), '<code>.po</code>', '<code>.mo</code>' ) );
		}
