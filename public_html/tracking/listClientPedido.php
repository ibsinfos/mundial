...
?>
 ...
 <header>
        ...
        <h1 align="center">Status Tracking</h1>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
						 ...
						 <form class="form-inline" id="tracking" action="trackingCliente.php"  method="post" name="tracking">
            ...
            <p>&copy; 2017 Todos os direitos reservados à <strong>Mundial Logistics Group</strong> | Desenvolvido por <a href="https://www.linkedin.com/in/ana-carolina-oliveira-dantas-b48ab294/?trk=hp-identity-photo">Ana Dantas</a></p>
            </div>
                        </div>
                    </div>
