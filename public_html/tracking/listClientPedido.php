...
$query = ("Select * from Vw_trackingPedido_new where CGC_LOJA= '$cnpj' and LOJA ='$loja' ");
...
<meta name="description"
	content="interface para usuario preecher informaçõe do tracking">
...
<body class="skin-black">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<form class="form-inline" id="tracking"
						action="trackingCliente.php" method="post" name="tracking">
						<div class="form-group">
							<label for="data1">Data Inico:</label> <input type="date"
								class="form-control" id="data1" name="data1"
								placeholder="Data Inicio">
						</div>
						<div class="form-group">
							<label for="data2">Data Fim:</label> <input type="date"
								class="form-control" id="data2" name="data2"
								placeholder="Data Fim"> <input type="hidden" name="cnpj"
								value="<?php echo $cnpj; ?>">
						</div>
	...
	while ( $row = mssql_fetch_array ( $consulta ) ) {
		...
		<div class="modal-footer no-margin-top">
			<p>
				&copy; 2017 Todos os direitos reservados à <strong>Mundial
	...
	<script src="js/ajax_libs_jquery_2.0.2_jquery.min.js"
