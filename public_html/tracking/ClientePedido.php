...
<body>
	...
	<div class="container">
		...
		<h2 class="steps-header" align="center">Tracking Mundial | Depositante
		</h2>
			...
			<div class="row" id="pwd-container">
				...
				<div class="col-md-4">
					<section class="login-form">
						...
						<form name="form1" method="post" action="listClientPedido.php"
							role="login">
							<input type="text" class="form-control" id="cnpj" name="cnpj"
								maxlength="14" onkeypress='return SomenteNumero(event)'
								required="required" placeholder="Digite aqui o numero do CNPJ.">
							<input type="text" class="form-control" id="loja" name="loja"
								maxlength="4" required="required"
								placeholder=" e o Codigo de Cliente.">
