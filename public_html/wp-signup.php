...
.mu_register input[type="submit"], .mu_register #blog_title,
	.mu_register #user_email, .mu_register #blogname, .mu_register #user_name
	{
	width: 100%;
	font-size: 24px;
	margin: 5px 0;
...
function show_user_form($user_name = '', $user_email = '', $errors = '') {
	...
	<input name="user_email" type="email" id="user_email"
			value="<?php  echo esc_attr($user_email) ?>" maxlength="200" /><br /><?php _e('We send your registration email to this address. (Double-check your email address before continuing.)')?>
	<?php
	 ...
	 *       
	 * @param WP_Error $errors
	 *        	A WP_Error object containing containing 'user_name' or 'user_email' errors.
	 */
...
printf(
			...
			__ ( '<a href="%1$s">%2$s</a> is your new site. <a href="%3$s">Log in</a> as &#8220;%4$s&#8221; using your existing password.' ), esc_url ( $home_url ), untrailingslashit ( $domain . $path ), esc_url ( $login_url ), $user_name );
	?>
	</p>
	<?php
	/**
