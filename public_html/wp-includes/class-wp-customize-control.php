...
class WP_Customize_Control {
	...
	final public function maybe_render() {
		 ...
		 * @since 3.4.0
		 *       
		 * @param WP_Customize_Control $this
		 *        	WP_Customize_Control instance.
		 */
	...
	protected function render() {
		$id = 'customize-control-' . str_replace ( array (
				'[',
				']' 
		), array (
				'-',
...
<label>
				...
				if (! empty ( $this->description )) :
					?>
						<span class="description customize-control-description"><?php echo $this->description; ?></span>
					<?php endif; ?>
					<textarea rows="5" <?php $this->input_attrs(); ?>
...
<div class="new-content-item">
	...
	<input type="text" id="create-input-<?php echo $this->id; ?>"
...
<script type="text/html"
	id="tmpl-customize-control-<?php echo $this->type; ?>-content">
