 ...
 * @param string $group
 *        	Optional. The group to add the cache to. Enables the same key
 ...
 * @param string $group
 *        	Optional. The group the key is in. Default empty.
 ...
 *        	Optional. Where the cache contents are grouped. Default empty.
 * @param bool $force
 *        	Optional. Whether to force an update of the local cache from the persistent
 *        	cache. Default false.
 * @param bool $found
 *        	Optional. Whether the key was found in the cache. Disambiguates a return of false,
 ...
 * @param string $group
 *        	Optional. Where to group the cache contents. Enables the same key
 *        	to be used across groups. Default empty.
 * @param int $expire
 *        	Optional. When to expire the cache contents, in seconds.
 *        	Default 0 (no expiration).
...
class WP_Object_Cache {
	 ...
	 *        	Optional. Where the cache contents are grouped. Default 'default'.
	 * @param string $force
	 *        	Optional. Unused. Whether to force a refetch rather than relying on the local
	 *        	cache. Default false.
	 * @param bool $found
	 *        	Optional. Whether the key was found in the cache. Disambiguates a return of
