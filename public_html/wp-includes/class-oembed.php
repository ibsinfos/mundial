...
class WP_oEmbed {
	...
	public function __construct() {
		...
		$providers = array (
				...
				'#https?://wordpress\.tv/.*#i' => array (
						'https://wordpress.tv/oembed/',
						true 
				),
				'#https?://(.+\.)?polldaddy\.com/.*#i' => array (
						'https://polldaddy.com/oembed/',
						true 
				),
				'#https?://poll\.fm/.*#i' => array (
						'https://polldaddy.com/oembed/',
						true 
				),
				...
				'#https?://(www\.)?twitter\.com/\w{1,15}/likes$#i' => array (
						'https://publish.twitter.com/oembed',
						true 
				),
				'#https?://(www\.)?twitter\.com/\w{1,15}/lists/.*#i' => array (
						'https://publish.twitter.com/oembed',
						true 
				),
				...
				'#https?://(www\.)?twitter\.com/i/moments/.*#i' => array (
						'https://publish.twitter.com/oembed',
						true 
				),
				...
				'#https?://(www\.)?soundcloud\.com/.*#i' => array (
				...
				'#https?://(www\.)?instagr(\.am|am\.com)/p/.*#i' => array (
				...
				'#https?://(.+\.)?imgur\.com/.*#i' => array (
						'http://api.imgur.com/oembed',
						true 
				),
				'#https?://(www\.)?meetu(\.ps|p\.com)/.*#i' => array (
						'https://api.meetup.com/oembed',
						true 
				),
				'#https?://(www\.)?issuu\.com/.+/docs/.+#i' => array (
				...
				'#https?://cloudup\.com/.*#i' => array (
						'https://cloudup.com/oembed',
						true 
				),
				'#https?://(www\.)?reverbnation\.com/.*#i' => array (
				...
				'#https?://(www\.)?reddit\.com/r/[^/]+/comments/.*#i' => array (
		 ...
		 *        	An array of popular oEmbed providers.
		 */
	 ...
	 *
	 * @param string $format
	 *        	Format of URL that this provider can handle. You can use
	 *        	asterisks as wildcards.
	 * @param string $provider
	 *        	The URL to the oEmbed provider..
	 * @param bool $regex
	 *        	Optional. Whether the $format parameter is in a regex format.
	 *        	Default false.
	 */
	 ...
	 *
	 * @param string $format
	 *        	The format of URL that this provider can handle. You can use
	 *        	asterisks as wildcards.
	 */
...
;
		...
		if ($html = wp_remote_retrieve_body ( $request )) {
			 ...
			 *       
			 * @param array $format
			 *        	Array of oEmbed link types. Accepts 'application/json+oembed',
