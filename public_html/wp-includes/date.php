...
class WP_Date_Query {
	 ...
	 *        	}
	 *        	}
	 * @param array $default_column
	 *        	Optional. Default column to query against. Default 'post_date'.
	...
	public function validate_column($column) {
		...
		if (false === strpos ( $column, '.' )) {
			 ...
			 *        	An array of valid date query columns. Defaults
	 ...
	 *        	Query to parse.
	 * @param int $depth
	 *        	Optional. Number of tree levels deep we currently are.
	 ...
	 *        	Whether to round up incomplete dates. Supported by values
