...
<?php
	...
	public function cache_oembed($post_ID) {
		 ...
		 *        	Array of post types to cache oEmbed results for. Defaults to post types with `show_ui` set to true.
		 */
	...
	public function autoembed($content) {
		...
		if (preg_match ( '#(^|\s|>)https?://#i', $content )) {
			...
			$content = preg_replace_callback ( '|(<p(?: [^>]*)?>\s*)(https?://[^\s<>"]+)(\s*<\/p>)|i', array (
					$this,
					'autoembed_callback' 
			), $content );
		}
