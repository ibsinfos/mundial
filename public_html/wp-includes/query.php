 ...
 * @global WP_Query $wp_query Global WP_Query instance.
 *        
 * @param int|string|array|object $attachment
 ...
 *        	Optional. Page ID, title, slug, or array of such. Default empty.
 ...
 *        	Optional. Post ID, title, slug, or array of such. Default empty.
...
function is_main_query() {
	if ('pre_get_posts' === current_filter ()) {
		$message = sprintf(
			...
			__ ( 'In %1$s, use the %2$s method, not the %3$s function. See %4$s.' ), '<code>pre_get_posts</code>', '<code>WP_Query->is_main_query()</code>', '<code>is_main_query()</code>', __ ( 'https://codex.wordpress.org/Function_Reference/is_main_query' ) );
