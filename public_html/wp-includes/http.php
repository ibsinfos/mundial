 ...
 * @param string $url
 *        	Optional. If given, will check if the URL requires SSL and adds
 ...
 *        	The URL to parse.
 * @param int $component
 *        	The specific component to retrieve. Use one of the PHP
