 ...
 *        	Optional. Image size to use. Accepts any valid image size, or
...
function get_the_post_thumbnail($post = null, $size = 'post-thumbnail', $attr = '') {
	 ...
	 *       
	 * @param string|array $size
	 *        	The post thumbnail size. Image size or array of width and height
	...
	if ($post_thumbnail_id) {
		 ...
		 * @param string|array $size
		 *        	The post thumbnail size. Image size or array of width
 ...
 *        	Optional. Post ID or WP_Post object. Default is global `$post`.
 * @param string|array $size
 *        	Optional. Registered image size to retrieve the source for or a flat
 ...
 *       
 * @param string|array $size
 *        	Optional. Image size to use. Accepts any valid image size,
