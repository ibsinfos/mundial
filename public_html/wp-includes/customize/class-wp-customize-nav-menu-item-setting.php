...
class WP_Customize_Nav_Menu_Item_Setting extends WP_Customize_Setting {
	 ...
	 * @param object $item
	 *        	Nav menu item.
	 * @return s string The type label.
	 */
	...
	public function preview() {
		...
		add_filter ( 'wp_get_nav_menu_items', array (
				$this,
	 ...
	 *        	The menu item array to update. If false, then the menu item will be deleted
