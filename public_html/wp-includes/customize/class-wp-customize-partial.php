...
class WP_Customize_Partial {
	 ...
	 *        	Optional. Array of context data associated with the target container (placement).
	 *        	Default empty array.
