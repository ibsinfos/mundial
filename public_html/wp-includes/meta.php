 ...
 *        	Metadata key
 * @param mixed $meta_value
 *        	Optional. Metadata value. Must be serializable if non-scalar. If specified, only delete
 *        	metadata entries with this value. Otherwise, delete all entries with the specified meta_key.
 *        	Pass `null, `false`, or an empty string to skip this check. (For backward compatibility,
 *        	it is not possible to pass an empty string to delete those entries with an empty string
 *        	for a value.)
 * @param bool $delete_all
 *        	Optional, default is false. If true, delete matching metadata entries for all objects,
...
function delete_metadata($meta_type, $object_id, $meta_key, $meta_value = '', $delete_all = false) {
	...
	if ('post' == $meta_type) {
		 ...
		 *       
		 * @param array $meta_ids
		 *        	An array of post metadata entry IDs to delete.
		 */
...
function get_metadata($meta_type, $object_id, $meta_key = '', $single = false) {
	 ...
	 *        	The value get_metadata() should return - a single metadata value,
 ...
 *        	Type of object the meta is registered to.
 *        	
 ...
 *       
 * @param string $object_type
 *        	The type of object. Post, comment, user, term.
 ...
 * @param string $meta_key
 *        	Optional. Registered metadata key. If not specified, retrieve all registered
