 ...
 *        	Optional. WP_Comment or the ID of the comment for which to retrieve the author.
 ...
 *       
 * @param int|WP_Comment $comment_ID
 *        	Optional. WP_Comment or the ID of the comment for which to print the author.
 *        	Default current comment.
 */
 ...
 *       
 * @param int|WP_Comment $comment_ID
 *        	Optional. WP_Comment or the ID of the comment for which to get the author's email.
 *        	Default current comment.
 ...
 *       
 * @param int|WP_Comment $comment_ID
 *        	Optional. WP_Comment or the ID of the comment for which to print the author's email.
 *        	Default current comment.
 */
 ...
 *       
 * @param int|WP_Comment $comment_ID
 *        	Optional. WP_Comment or the ID of the comment for which to print the author's link.
 *        	Default current comment.
 */
 ...
 *       
 * @param int|WP_Comment $comment_ID
 *        	Optional. WP_Comment or the ID of the comment for which to get the author's IP address.
 *        	Default current comment.
 ...
 *       
 * @param int|WP_Comment $comment_ID
 *        	Optional. WP_Comment or the ID of the comment for which to get the author's URL.
 *        	Default current comment.
 ...
 *       
 * @param int|WP_Comment $comment_ID
 *        	Optional. WP_Comment or the ID of the comment for which to print the author's URL.
 *        	Default current comment.
 */
 ...
 *       
 * @param string $linktext
 *        	Optional. The text to display instead of the comment
 ...
 *       
 * @param string $linktext
 *        	Optional. Text to display instead of the comment author's
 ...
 * @param bool $echo
 *        	Optional. Whether to cho or return the output.
 *        	Default true.
 ...
 *        
 * @param string|array $class
 *        	Optional. One or more classes to add to the class list. Default empty.
 * @param int|WP_Comment $comment_id
 *        	Comment ID or WP_Comment object. Default current comment.
 * @param int|WP_Post $post_id
 *        	Post ID or WP_Post object. Default current post.
 ...
 *       
 * @param string $d
 *        	Optional. The format of the date. Default user's setting.
 * @param int|WP_Comment $comment_ID
 ...
 *       
 * @param string $d
 *        	Optional. The format of the date. Default user's settings.
 * @param int|WP_Comment $comment_ID
...
function get_comments_number_text($zero = false, $one = false, $more = false) {
	 ...
	 *
	 * @param string $output
	 *        	A translatable string formatted based on whether the count
 ...
 *        	Default current comment.
 * @param array $args
 *        	Optional. An array of arguments. Default empty.
 ...
 *        	Default current comment.
 * @param array $args
 *        	Optional. An array of arguments. Default empty array. Default empty.
 */
 ...
 *       
 * @param int|WP_Comment $comment_ID
 *        	Optional. WP_Comment or ID of the comment for which to get the type.
 *        	Default current comment.
 ...
 *        	Optional. String to display for comment type. Default false.
 * @param string $trackbacktxt
 *        	Optional. String to display for trackback type. Default false.
 * @param string $pingbacktxt
 *        	Optional. String to display for pingback type. Default false.
 */
...
function trackback_url($deprecated_echo = true) {
	if (true !== $deprecated_echo) {
		_deprecated_argument ( __FUNCTION__, '2.5.0',
			...
			sprintf ( __ ( 'Use %s instead if you do not want the value echoed.' ), '<code>get_trackback_url()</code>' ) );
	}
 ...
 *        
 * @param string $file
 *        	Optional. The file to load. Default '/comments.php'.
 ...
 *       
 * @param string $zero
 *        	Optional. String to display when no comments. Default false.
 * @param string $one
 *        	Optional. String to display when only one comment is available.
 *        	Default false.
 * @param string $more
 *        	Optional. String to display when there are more than one comment.
 *        	Default false.
 * @param string $css_class
 *        	Optional. CSS class to use for comments. Default empty.
 * @param string $none
 *        	Optional. String to display when comments have been turned off.
 *        	Default false.
 */
...
function get_comment_reply_link($args = array(), $comment = null, $post = null) {
	 ...
	 *       
	 * @param array $args
	 *        	Comment reply link arguments. See get_comment_reply_link()
 ...
 *       
 * @param string $text
 *        	Optional. Text to display for cancel reply link. Default empty.
 * @return string
 */
 ...
 *        
 * @param string $noreplytext
 *        	Optional. Text to display when not replying to a comment.
 *        	Default false.
 * @param string $replytext
 *        	Optional. Text to display when replying to a comment.
 *        	Default false. Accepts "%s" for the author of the comment
 *        	being replied to.
 * @param string $linktoparent
 *        	Optional. Boolean to control making the author's name a link
 ...
 *        	}
 * @param array $comments
 *        	Optional. Array of WP_Comment objects.
 */
...
function comment_form($args = array(), $post_id = null) {
	...
	$fields = array (
			...
			'email' => '<p class="comment-form-email"><label for="email">' . __ ( 'Email' ) . ($req ? ' <span class="required">*</span>' : '') . '</label> ' . '<input id="email" name="email" ' . ($html5 ? 'type="email"' : 'type="text"') . ' value="' . esc_attr ( $commenter ['comment_author_email'] ) . '" size="30" maxlength="100" aria-describedby="email-notes"' . $aria_req . $html_req . ' /></p>',
	...
	$defaults = array (
			...
			'must_log_in' => '<p class="must-log-in">' . sprintf(
		                              ...
		                              __ ( 'You must be <a href="%s">logged in</a> to post a comment.' ), wp_login_url ( apply_filters ( 'the_permalink', get_permalink ( $post_id ) ) ) ) . '</p>',
			/**
			 * This filter is documented in wp-includes/link-template.php
			 */
			'logged_in_as' => '<p class="logged-in-as">' . sprintf(
		                              ...
		                              esc_attr ( sprintf ( __ ( 'Logged in as %s. Edit your profile.' ), $user_identity ) ), $user_identity, wp_logout_url ( apply_filters ( 'the_permalink', get_permalink ( $post_id ) ) ) ) . '</p>',
