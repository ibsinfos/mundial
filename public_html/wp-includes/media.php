 ...
 *        	Optional. Image size. Accepts any valid image size, or an array
 *        	of width and height values in pixels (in that order).
 *        	Default 'medium'.
 * @param string $context
 *        	Optional. Could be 'display' (like in a theme) or 'edit'
...
function image_constrain_size_for_editor($width, $height, $size = 'medium', $context = null) {
	 ...
	 * @since 2.5.0
	 *       
	 * @param array $max_image_size
	 *        	An array with the width as the first element,
 ...
 *        	Optional. Image size to scale to. Accepts any valid image size,
 ...
 *        	Optional. Whether to crop images to specified width and height or resize.
 ...
 * @param string|array $size
 *        	Optional. Registered image size to retrieve a tag for. Accepts any
 ...
 * @param int $max_width
 *        	Optional. Max width in pixels to constrain to. Default 0.
 * @param int $max_height
 *        	Optional. Max height in pixels to constrain to. Default 0.
...
function image_get_intermediate_size($post_id, $size = 'thumbnail') {
	 ...
	 *
	 * @param array $data
	 *        	Array of file relative path, width, and height on success. May also include
	 *        	file absolute path and URL.
	 * @param int $post_id
	 *        	The post_id of the image attachment
	 * @param string|array $size
	 *        	Registered image size or flat array of initially-requested height and width
...
function get_intermediate_image_sizes() {
	 ...
	 *        	An array of intermediate image sizes. Defaults
 ...
 *        	Image attachment ID.
 * @param string|array $size
 *        	Optional. Image size. Accepts any valid image size, or an array of width
...
function wp_get_attachment_image_src($attachment_id, $size = 'thumbnail', $icon = false) {
	 ...
	 *        	Image attachment ID.
	 * @param string|array $size
	 *        	Size of image. Image size or array of width and height values
...
function wp_get_attachment_image($attachment_id, $size = 'thumbnail', $icon = false, $attr = '') {
	...
	if ($image) {
		 ...
		 * @param string|array $size
		 *        	Requested size. Image size or array of width and height values
		 *        	(in that order). Default 'thumbnail'.
		 */
 ...
 *        	Image attachment ID.
 * @param string|array $size
 *        	Optional. Image size to retrieve. Accepts any valid image size, or an array
 ...
 *        	Image attachment ID.
 * @param array|string $size
 *        	Optional. Image size. Accepts any valid image size, or an array of
 ...
 * @param int $attachment_id
 *        	Optional. The image attachment ID to pass to the filter. Default 0.
...
function wp_calculate_image_srcset($size_array, $image_src, $image_meta, $attachment_id = 0) {
	 ...
	 * meta match our $image_src.
	 * If no matches are found we don't return a srcset to avoid serving
 ...
 *       
 * @param array|string $size
 *        	Image size to retrieve. Accepts any valid image size, or an array
 ...
 *        	Default null.
 * @param int $attachment_id
 *        	Optional. Image attachment ID. Either `$image_meta` or `$attachment_id`
...
function img_caption_shortcode($attr, $content = null) {
	 ...
	 *
	 * @param int $width
	 *        	Width of the caption in pixels. To remove this inline style,
	 *        	return zero.
	 * @param array $atts
	 *        	Attributes of the caption shortcode.
	 * @param string $content
...
function wp_playlist_shortcode($attr) {
	...
	?>
<div
	class="wp-playlist wp-<?php echo $safe_type ?>-playlist wp-playlist-<?php echo $safe_style ?>">
...
function wp_get_audio_extensions() {
	 ...
	 *        	An array of support audio formats. Defaults are
	 *        	'mp3', 'ogg', 'wma', 'm4a', 'wav'.
	 */
	return apply_filters ( 'wp_audio_extensions', array (
			'mp3',
			'ogg',
			'wma',
			'm4a',
...
function wp_get_video_extensions() {
	 ...
	 *       
	 * @param array $extensions
	 *        	An array of support video formats. Defaults are
	 *        	'mp4', 'm4v', 'webm', 'ogv', 'wmv', 'flv'.
	 */
	return apply_filters ( 'wp_video_extensions', array (
			'mp4',
			'm4v',
			'webm',
			'ogv',
 ...
 *
 * @param string|array $size
 *        	Optional. Image size. Accepts any valid image size, an array of width and
 ...
 * @param string|array $size
 *        	Optional. Image size. Accepts any valid image size, or an array of width and height
 ...
 * @param string $output
 *        	Output type. 'names' to return an array of taxonomy names,
 ...
 *
 * @param string $output
 *        	Optional. The type of taxonomy output to return. Accepts 'names' or 'objects'.
 *        	Default 'names'.
...
function _wp_image_editor_choose($args = array()) {
	 ...
	 *        	List of available image editors. Defaults are
	...
	foreach ( $implementations as $implementation ) {
		...
		if (isset ( $args ['mime_type'] ) && ! call_user_func ( array (
				$implementation,
				'supports_mime_type' 
		), $args ['mime_type'] )) {
			continue;
...
function wp_plupload_default_settings() {
	 ...
	 *        	Default Plupload settings array.
	 */
	 ...
	 *       
	 * @param array $params
	 *        	Default Plupload parameters array.
	 */
...
;
	 ...
	 *      
	 * @param
	 *        	bool|null Whether to show the button, or `null` for default behavior.
	 */
	 ...
	 *      
	 * @param
	 *        	array|null An array of objects with `month` and `year`
...
function get_media_embedded_in_content($content, $types = null) {
	 ...
	 *        	An array of allowed media types. Default media types are
		...
		foreach ( $matches as $shortcode ) {
			if ('gallery' === $shortcode [2]) {
				...
				if ($html) {
					...
					$galleries [] = array_merge ( $shortcode_attrs, array (
