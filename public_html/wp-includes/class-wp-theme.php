...
final class WP_Theme implements ArrayAccess {
		...
		if (! $this->template && ! ($this->template = $this->headers ['Template'])) {
			...
			if (! file_exists ( $this->theme_root . '/' . $this->stylesheet . '/index.php' )) {
				$error_message = sprintf(
					...
					__ ( 'Template is missing. Standalone themes need to have a %1$s template file. <a href="%2$s">Child themes</a> need to have a Template header in the %3$s stylesheet.' ), '<code>index.php</code>', __ ( 'https://codex.wordpress.org/Child_Themes' ), '<code>style.css</code>' );
	 ...
	 *        
	 * @param mixed $type
	 *        	Optional. Array of extensions to return. Defaults to all files (null).
	 * @param int $depth
	 *        	Optional. How deep to search for files. Defaults to a flat scan (0 depth). -1 depth is infinite.
	 * @param bool $search_parent
	 *        	Optional. Whether to return parent files. Defaults to false.
	...
	public function get_post_templates() {
		...
		if ($this->errors () && $this->errors ()->get_error_codes () !== array (
	...
	public function get_page_templates($post = null, $post_type = 'page') {
		 ...
		 *        	Array of page templates. Keys are filenames,
	 ...
	 *        	Optional. Array of extensions to find, string of a single extension,
	 *        	or null for all extensions. Default null.
	 * @param int $depth
	 *        	Optional. How many levels deep to search for files. Accepts 0, 1+, or
	 *        	-1 (infinite depth). Default 0.
	 * @param string $relative_path
	 *        	Optional. The basename of the absolute path. Used to control the
	...
	private static function scandir($path, $extensions = null, $depth = 0, $relative_path = '') {
		 ...
		 */
		$exclusions = ( array ) apply_filters ( 'theme_scandir_exclusions', array (
				'CVS',
				'node_modules' 
		) );
	 ...
	 *        
	 * @param string $check
	 *        	Optional. Whether to check only the 'network'-wide settings, the 'site'
	 ...
	 *        
	 * @param array $themes
	 *        	Array of themes to sort, passed by reference.
	 */
