...
class Requests_Transport_cURL implements Requests_Transport {
	...
	public function request($url, $headers = array(), $data = array(), $options = array()) {
		...
		$options ['hooks']->dispatch ( 'curl.before_send', array (
				&$this->handle 
		) );
	...
	public function request_multiple($requests, $options) {
		...
		foreach ( $requests as $id => $request ) {
			...
			$request ['options'] ['hooks']->dispatch ( 'curl.before_multi_add', array (
					&$subhandles [$id] 
			) );
		...
		$request ['options'] ['hooks']->dispatch ( 'curl.before_multi_exec', array (
				&$multihandle 
		) );
		...
		$request ['options'] ['hooks']->dispatch ( 'curl.after_multi_exec', array (
				&$multihandle 
		) );
	...
	protected function setup_handle($url, $headers, $data, $options) {
		$options ['hooks']->dispatch ( 'curl.before_request', array (
				&$this->handle 
		) );
		...
		if (true === $options ['blocking']) {
			curl_setopt ( $this->handle, CURLOPT_HEADERFUNCTION, array (
					&$this,
					'stream_headers' 
			) );
	...
	public function process_response($response, $options) {
		if ($options ['blocking'] === false) {
			$fake_headers = '';
			$options ['hooks']->dispatch ( 'curl.after_request', array (
					&$fake_headers 
			) );
			return false;
		}
	...
	public function stream_body($handle, $data) {
		$this->hooks->dispatch ( 'request.progress', array (
				$data,
				$this->response_bytes,
