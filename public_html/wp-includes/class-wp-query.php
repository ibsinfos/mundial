...
class WP_Query {
	 ...
	 * Used to catch modifications to query vars made
	 ...
	 */
	private $stopwords;
	private $compat_fields = array (
			'query_vars_hash',
			'query_vars_changed' 
	);
	private $compat_methods = array (
			'init_query_flags',
			'parse_tax_query' 
	);
	...
	public function parse_query($query = '') {
		 ...
		 */
		do_action_ref_array ( 'parse_query', array (
				&$this 
		) );
	}
	...
	public function get_posts() {
		 ...
		 *        	WP_Query &$this The WP_Query instance (passed by reference).
		 */
		do_action_ref_array ( 'pre_get_posts', array (
				&$this 
		) );
		...
		if (! $q ['suppress_filters']) {
			 ...
			 */
			$search = apply_filters_ref_array ( 'posts_search', array (
					$search,
					&$this 
			) );
		}
		...
		if (! empty ( $this->tax_query->queried_terms )) {
			...
			if (! isset ( $q ['taxonomy'] )) {
				foreach ( $this->tax_query->queried_terms as $queried_taxonomy => $queried_items ) {
					...
					if (! in_array ( $queried_taxonomy, array (
							'category',
							'post_tag' 
					) )) {
		...
		if (! $q ['suppress_filters']) {
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$where = apply_filters_ref_array ( 'posts_where', array (
					$where,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$join = apply_filters_ref_array ( 'posts_join', array (
					$join,
					&$this 
			) );
		}
		...
		if ($this->is_comment_feed && ! $this->is_singular) {
			...
			if (! $q ['suppress_filters']) {
				 ...
				 *        	WP_Query &$this The WP_Query instance (passed by reference).
				 */
				$cjoin = apply_filters_ref_array ( 'comment_feed_join', array (
						$cjoin,
						&$this 
				) );
				 ...
				 *        	WP_Query &$this The WP_Query instance (passed by reference).
				 */
				$cwhere = apply_filters_ref_array ( 'comment_feed_where', array (
						$cwhere,
						&$this 
				) );
				 ...
				 * @since 2.2.0
				 *       
				 * @param string $cgroupby
				 *        	The GROUP BY clause of the query.
				 * @param
				 *        	WP_Query &$this The WP_Query instance (passed by reference).
				 */
				$cgroupby = apply_filters_ref_array ( 'comment_feed_groupby', array (
						$cgroupby,
						&$this 
				) );
				 ...
				 * @since 2.8.0
				 *       
				 * @param string $corderby
				 *        	The ORDER BY clause of the query.
				 * @param
				 *        	WP_Query &$this The WP_Query instance (passed by reference).
				 */
				$corderby = apply_filters_ref_array ( 'comment_feed_orderby', array (
				 ...
				 *        	WP_Query &$this The WP_Query instance (passed by reference).
				 */
				$climits = apply_filters_ref_array ( 'comment_feed_limits', array (
		...
		if (! $q ['suppress_filters']) {
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$where = apply_filters_ref_array ( 'posts_where_paged', array (
					$where,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$groupby = apply_filters_ref_array ( 'posts_groupby', array (
					$groupby,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$join = apply_filters_ref_array ( 'posts_join_paged', array (
					$join,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$orderby = apply_filters_ref_array ( 'posts_orderby', array (
					$orderby,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$distinct = apply_filters_ref_array ( 'posts_distinct', array (
					$distinct,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$limits = apply_filters_ref_array ( 'post_limits', array (
					$limits,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$fields = apply_filters_ref_array ( 'posts_fields', array (
					$fields,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$clauses = ( array ) apply_filters_ref_array ( 'posts_clauses', array (
					compact ( $pieces ),
					&$this 
			) );
		...
		if (! $q ['suppress_filters']) {
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$where = apply_filters_ref_array ( 'posts_where_request', array (
					$where,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$groupby = apply_filters_ref_array ( 'posts_groupby_request', array (
					$groupby,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$join = apply_filters_ref_array ( 'posts_join_request', array (
					$join,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$orderby = apply_filters_ref_array ( 'posts_orderby_request', array (
					$orderby,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$fields = apply_filters_ref_array ( 'posts_fields_request', array (
					$fields,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$limits = apply_filters_ref_array ( 'post_limits_request', array (
					$limits,
					&$this 
			) );
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$clauses = ( array ) apply_filters_ref_array ( 'posts_clauses_request', array (
					compact ( $pieces ),
					&$this 
			) );
		...
		if (! $q ['suppress_filters']) {
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$this->request = apply_filters_ref_array ( 'posts_request', array (
					$this->request,
					&$this 
			) );
		}
		 ...
		 */
		$this->posts = apply_filters_ref_array ( 'posts_pre_query', array (
				null,
				&$this 
		) );
		...
		if (! $q ['suppress_filters']) {
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$this->posts = apply_filters_ref_array ( 'posts_results', array (
					$this->posts,
					&$this 
			) );
		}
		...
		if (! empty ( $this->posts ) && ($this->is_single || $this->is_page)) {
			...
			if ($this->is_preview && $this->posts && current_user_can ( $edit_cap, $this->posts [0]->ID )) {
				 ...
				 * @since 2.7.0
				 *       
				 * @param WP_Post $post_preview
				 *        	The Post object.
				 * @param
				 *        	WP_Query &$this The WP_Query instance (passed by reference).
				 */
				$this->posts [0] = get_post ( apply_filters_ref_array ( 'the_preview', array (
						$this->posts [0],
						&$this 
				) ) );
			}
		...
		if ($this->is_home && $page <= 1 && is_array ( $sticky_posts ) && ! empty ( $sticky_posts ) && ! $q ['ignore_sticky_posts']) {
			...
			for($i = 0; $i < $num_posts; $i ++) {
				if (in_array ( $this->posts [$i]->ID, $sticky_posts )) {
					...
					array_splice ( $this->posts, $sticky_offset, 0, array (
							$sticky_post 
					) );
		...
		if (! $q ['suppress_filters']) {
			 ...
			 *       
			 * @param array $posts
			 *        	The array of retrieved posts.
			 * @param
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$this->posts = apply_filters_ref_array ( 'the_posts', array (
					$this->posts,
					&$this 
			) );
		}
	...
	private function set_found_posts($q, $limits) {
		...
		if (! empty ( $limits )) {
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			$this->found_posts = $wpdb->get_var ( apply_filters_ref_array ( 'found_posts_query', array (
					'SELECT FOUND_ROWS()',
					&$this 
			) ) );
		} else {
		 ...
		 *        	WP_Query &$this The WP_Query instance (passed by reference).
		 */
		$this->found_posts = apply_filters_ref_array ( 'found_posts', array (
				$this->found_posts,
				&$this 
		) );
	...
	public function the_post() {
		...
		if ($this->current_post == - 1) // loop has just started
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			do_action_ref_array ( 'loop_start', array (
					&$this 
			) );
	...
	public function have_posts() {
		if ($this->current_post + 1 < $this->post_count) {
			 ...
			 *        	WP_Query &$this The WP_Query instance (passed by reference).
			 */
			do_action_ref_array ( 'loop_end', array (
					&$this 
			) );
	...
	public function is_tax($taxonomy = '', $term = '') {
		...
		return isset ( $queried_object->term_id ) && count ( array_intersect ( array (
	...
	public function setup_postdata($post) {
		 ...
		 *       
		 * @param array $pages
		 *        	Array of "pages" derived from the post content.
		 *        	of `<!-- nextpage -->` tags..
		 * @param WP_Post $post
		 *        	Current post object.
		 */
