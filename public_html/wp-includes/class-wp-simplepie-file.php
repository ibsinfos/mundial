...
class WP_SimplePie_File extends SimplePie_File {
	 ...
	 *        	Optional. The number of allowed redirects. Default 5.
	 * @param string|array $headers
	 *        	Optional. Array or string of headers to send with the request.
	 *        	Default null.
	 * @param string $useragent
	 *        	Optional. User-agent value sent. Default null.
	 * @param boolean $force_fsockopen
	 *        	Optional. Whether to force opening internet or unix domain socket
