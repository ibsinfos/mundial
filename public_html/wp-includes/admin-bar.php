...
function _wp_admin_bar_init() {
	 ...
	 * @since 3.1.0
	 *       
	 * @param string $wp_admin_bar_class
	 *        	Admin bar class to use. Default 'WP_Admin_Bar'.
	 */
...
function wp_admin_bar_render() {
	 ...
	 */
	do_action_ref_array ( 'admin_bar_menu', array (
			&$wp_admin_bar 
	) );
 ...
 *        	Context of this preference check. Defaults to 'front'. The 'admin'
