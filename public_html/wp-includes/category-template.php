...
function get_the_category_list($separator = '', $parents = '', $post_id = false) {
	 ...
	 *        	ID of the post we're retrieving categories for. When `false`, we assume the
	 ...
	 * @param string $parents
	 *        	How to display the category parents. Accepts 'multiple',
	 *        	'single', or empty.
	 */
 ...
 *       
 * @param int $category
 *        	Optional. Category ID. Will use global category ID by default.
...
function wp_generate_tag_cloud($tags, $args = '') {
	 ...
	 *        	An array of term data for term used to generate the tag cloud.
	 */
	...
	if ($args ['filter']) {
		 ...
		 *        	String containing the generated HTML tag cloud output
 ...
 *       
 * @param int $tag
 *        	Optional. Tag ID. Will use global tag ID by default.
 ...
 *        	Optional. The tag name/term_id/slug or array of them to check for.
 * @param int|object $post
 *        	Optional. Post to check instead of the current post. (since 2.7.0)
