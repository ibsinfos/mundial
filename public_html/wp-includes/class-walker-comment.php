...
class Walker_Comment extends Walker {
	 ...
	 * @param array $args
	 *        	Optional. Uses 'style' argument for type of HTML list. Default empty array.
	 */
	 ...
	 *        	Used to append additional content. Passed by reference.
	 * @param WP_Comment $comment
	 *        	The current comment object. Default current comment.
	 * @param int $depth
	 *        	Optional. Depth of the current comment. Default 0.
	 * @param array $args
	 *        	Optional. An array of arguments. Default empty array.
...
<div id="div-comment-<?php comment_ID(); ?>" class="comment-body">
		...
		printf ( __ ( '%s <span class="says">says:</span>' ), sprintf ( '<cite class="fn">%s</cite>', get_comment_author_link ( $comment ) ) );
		?>
		</div>
