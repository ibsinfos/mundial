...
if (! function_exists ( 'wp_mail' )) :
	...
	function wp_mail($to, $subject, $message, $headers = '', $attachments = array()) {
		...
		try {
			 ...
			 *        	A WP_Error object with the phpmailerException message, and an array
...
if (! function_exists ( 'wp_new_user_notification' )) :
	 ...
	 * @param string $notify
	 *        	Optional. Type of notification that should happen. Accepts 'admin' or an empty
...
if (! function_exists ( 'get_avatar' )) :
	 ...
	 * @param int $size
	 *        	Optional. Height and width of the avatar image file in pixels. Default 96.
	 * @param string $default
	 *        	Optional. URL for the default image or a default type. Accepts '404'
	 ...
	 * @param string $alt
	 *        	Optional. Alternative text to use in &lt;img&gt; tag. Default empty.
	 * @param array $args
	 *        	{
...
if (! function_exists ( 'wp_text_diff' )) :
	 ...
	 *        	Optional. Change 'title', 'title_left', and 'title_right' defaults.
