 ...
 *        
 * @param int $number
 *        	Optional. Number of sidebars to create. Default 1.
 ...
 *        
 * @param string $name
 *        	The ID of the sidebar when it was added.
 */
 ...
 * @global array $wp_registered_widgets
 *        
 * @param string|false $callback
 *        	Optional, Widget callback to check. Default false.
 * @param int|false $widget_id
 *        	Optional. Widget ID. Optional, but needed for checking. Default false.
 * @param string|false $id_base
 *        	Optional. The base ID of a widget created by extending WP_Widget. Default false.
 * @param bool $skip_inactive
 *        	Optional. Whether to check in 'wp_inactive_widgets'. Default true.
 ...
 *        	Whether the theme was changed as a boolean. A value
...
<p>
	...
	<select id="rss-items-<?php echo $esc_number; ?>"
		name="widget-rss[<?php echo $esc_number; ?>][items]">
	<?php
		for($i = 1; $i <= 20; ++ $i) {
...
<p>
	<input id="rss-show-date-<?php echo $esc_number; ?>"
		...
		type="checkbox" value="1" <?php checked( $args['show_date'] ); ?> /> <label
		for="rss-show-date-<?php echo $esc_number; ?>"><?php _e( 'Display item date?' ); ?></label>
</p>
 ...
 *        	Optional, default is true. Whether to check feed for errors.
 * @return array
 */
