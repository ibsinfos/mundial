...
class WP_Term_Query {
	...
	public function parse_query($query = '') {
		 ...
		 * @since 4.6.0
		 *       
		 * @param WP_Term_Query $this
		 *        	Current instance of WP_Term_Query.
		 */
	...
	public function get_terms() {
		...
		if (! empty ( $exclude_tree )) {
			...
			foreach ( $exclude_tree as $extrunk ) {
				$excluded_children = array_merge ( $excluded_children, ( array ) get_terms ( $taxonomies [0], array (
