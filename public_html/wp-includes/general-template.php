 ...
 *        
 * @param string $sep
 *        	Optional, default is '&raquo;'. How to separate the various items
 ...
 *
 * @param string $before
 *        	Optional. Content to prepend to the description. Default empty.
 * @param string $after
 *        	Optional. Content to append to the description. Default empty.
 */
...
function the_date($d = '', $before = '', $after = '', $echo = true) {
	...
	if (is_new_day ()) {
		 ...
		 * @param string $d
		 *        	PHP date format. Defaults to 'date_format' option
		 *        	if not specified.
		 * @param string $before
...
function get_the_modified_date($d = '', $post = null) {
	 ...
	 *        	The formatted date.
	 * @param string $d
	 *        	PHP date format. Defaults to value specified in
	 *        	'date_format' option.
	 * @param WP_Post $post
	 *        	WP_Post object.
	 */
...
function the_time($d = '') {
	 ...
	 * @since 0.71
	 *       
	 * @param string $get_the_time
	 *        	The formatted time.
	 * @param string $d
	 *        	The time format. Accepts 'G', 'U',
	 *        	or php date format.
	 */
 ...
 *       
 * @param string $d
 *        	Optional. Format to use for retrieving the time the post
...
function the_modified_time($d = '') {
	 ...
	 * @since 2.0.0
	 *       
	 * @param string $get_the_modified_time
	 *        	The formatted time.
	 * @param string $d
	 *        	The time format. Accepts 'G', 'U',
...
function get_the_modified_time($d = '', $post = null) {
	 ...
	 *        	The formatted time.
	 * @param string $d
	 *        	Format to use for retrieving the time the post was
...
function get_post_modified_time($d = 'U', $gmt = false, $post = null, $translate = false) {
	 ...
	 *        	The formatted time.
	 * @param string $d
	 *        	The date format. Accepts 'G', 'U', or php date format. Default 'U'.
	 * @param bool $gmt
	 *        	Whether to return the GMT time. Default false.
	 */
 ...
 *       
 * @param bool $escaped
 *        	Whether the result is escaped. Default true.
 ...
 * @param array $colors
 *        	Optional. An array of CSS color definition strings which are used
...
function register_admin_color_schemes() {
	...
	wp_admin_css_color ( 'coffee', _x ( 'Coffee', 'admin color scheme' ), admin_url ( "css/colors/coffee/colors$suffix.css" ), array (
			'#46403c',
			'#59524c',
			'#c7a589',
			'#9ea476' 
...
function wp_admin_css($file = 'wp-admin', $force_echo = false) {
	 ...
	 *       
	 * @param string $file
	 *        	Style handle name or filename (without ".css" extension)
...
function the_generator($type) {
	 ...
	 * @param string $type
	 *        	The type of generator to output. Accepts 'html',
...
function get_the_generator($type = '') {
	 ...
	 * @param string $type
	 *        	The type of generator. Accepts 'html', 'xhtml', 'atom',
