...
class WP_Widget {
	 ...
	 *        	Optional. Widget options. See wp_register_sidebar_widget() for information
	 ...
	 *        
	 * @param int $number
	 *        	The unique order number of this widget instance compared to other
	 ...
	 *        
	 * @param array $args
	 *        	Display arguments. See WP_Widget::widget() for information
	...
	public function form_callback($widget_args = 1) {
		...
		if (false !== $instance) {
			 ...
			 */
			do_action_ref_array ( 'in_widget_form', array (
					&$this,
					&$return,
					$instance 
			) );
	 ...
	 *        	Optional. The unique order number of this widget instance
