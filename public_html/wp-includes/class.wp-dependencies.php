...
class WP_Dependencies {
	 ...
	 *        	Name of the item. Should be unique.
	 * @param string $src
	 *        	Full URL of the item, or path of the item relative to the WordPress root directory.
	 * @param array $deps
	 *        	Optional. An array of registered item handles this item depends on. Default empty array.
	 * @param string|bool|null $ver
	 *        	Optional. String specifying item version number, if it has one, which is added to the URL
