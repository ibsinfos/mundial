...
if (! function_exists ( 'mb_substr' )) :
	 ...
	 *        	Optional. Maximum number of characters to extract from `$str`.
	 *        	Default null.
	 * @param string|null $encoding
	 *        	Optional. Character encoding to use. Default null.
...
if (! function_exists ( 'spl_autoload_register' )) :
	 ...
	 * @param bool $throw
	 *        	Optional. Whether the function should throw an exception
