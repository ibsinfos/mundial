...
final class WP_Hook implements Iterator, ArrayAccess {
	 ...
	 * @param int $priority
	 *        	The order in which the functions associated with a
	 ...
	 * @access private
	 *        
	 * @param bool|int $new_priority
	 *        	Optional. The priority of the new filter being added. Default false,
	 *        	for no priority being added.
	 * @param bool $priority_existed
	 *        	Optional. Flag for whether the priority already existed before the new
	 ...
	 *        
	 * @param string $tag
	 *        	The filter hook to which the function to be removed is hooked. Used
	 ...
	 *        
	 * @param mixed $args
	 *        	Arguments to pass to the hook callbacks.
	 */
