 ...
 * @param string $output
 *        	Optional. The required return type. One of OBJECT, ARRAY_A, or ARRAY_N, which correspond to a
 ...
 *        	Optional. Whether full path should be matched.
 * @param string $output
...
function get_tags($args = '') {
	 ...
	 *       
	 * @param array $tags
	 *        	Array of 'post_tag' term objects.
	 * @param array $args
	 *        	An array of arguments. @see get_terms()
	 */
