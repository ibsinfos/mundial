...
function wp_add_inline_style($handle, $data) {
	...
	if (false !== stripos ( $data, '</style>' )) {
		_doing_it_wrong ( __FUNCTION__, sprintf(
			...
			__ ( 'Do not pass %1$s tags to %2$s.' ), '<code>&lt;style&gt;</code>', '<code>wp_add_inline_style()</code>' ), '3.7.0' );
 ...
 *        	Optional. String specifying stylesheet version number, if it has one, which is added to the URL
