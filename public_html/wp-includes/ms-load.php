...
function ms_site_check() {
	...
	if ('1' == $blog->deleted) {
		if (file_exists ( WP_CONTENT_DIR . '/blog-deleted.php' ))
			...
			wp_die ( __ ( 'This site is no longer available.' ), '', array (
					'response' => 410 
			) );
	}
...
function get_site_by_path($domain, $path, $segments = null) {
	 ...
	 *       
	 * @param int|null $segments
	 *        	The number of path segments to consider. WordPress by default looks at
 ...
 *        	Optional. Whether a subdomain (true) or subdirectory (false) configuration.
 *        	Default false.
