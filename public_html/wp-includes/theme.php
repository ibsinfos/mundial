 ...
 *        	Absolute path of the theme root to look in. Optional. If not specified, get_raw_theme_root()
...
function get_stylesheet_uri() {
	 ...
	 *        	Stylesheet URI for the current theme/child theme.
	 * @param string $stylesheet_dir_uri
 ...
 *        	Optional. Whether to skip the cache.
...
function validate_current_theme() {
	 ...
	 *       
	 * @param bool $validate
	 *        	Whether to validate the current theme. Default true.
	 */
 ...
 *       
 * @param array $attr
 *        	Optional. Additional attributes for the image tag. Can be used
...
function is_header_video_active() {
	 ...
	 * @since 4.7.0
	 *       
	 * @param bool $show_video
	 *        	Whether the custom header video should be shown. Returns the value
...
function get_editor_stylesheets() {
	 ...
	 *        	Array of stylesheets to be applied to the editor.
	 */
			...
			case 'posts' :
				foreach ( $config [$type] as $id => $item ) {
					if (is_array ( $item )) {
						...
						$content [$type] [$id] = wp_array_slice_assoc ( $item, array (
								'post_type',
								'post_title',
								'post_excerpt',
								'post_name',
 ...
 *       
 * @param string $stylesheet
 *        	Optional. Theme to customize. Defaults to current theme.
