...
function get_default_feed() {
	 ...
	 *        	Type of default feed. Possible values include 'rss2', 'atom'.
	 *        	Default 'rss2'.
	 */
...
function comments_link_feed() {
	 ...
	 * @since 3.6.0
	 *       
	 * @param string $comment_permalink
	 *        	The current comment permalink with
	 *        	'#comments' appended.
	 */
 ...
 *       
 * @param mixed $url
 *        	URL of feed to retrieve. If an array of URLs, the feeds are merged
...
function fetch_feed($url) {
	 ...
	 *        	URL of feed to retrieve. If an array of URLs, the feeds are merged.
	 */
	do_action_ref_array ( 'wp_feed_options', array (
			&$feed,
			$url 
	) );
	$feed->init ();
