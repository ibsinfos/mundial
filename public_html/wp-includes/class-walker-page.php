...
class Walker_Page extends Walker {
	 ...
	 * @param array $args
	 *        	Optional. Arguments for outputting the next level.
	 *        	Default empty array.
	 */
	...
	public function start_el(&$output, $page, $depth = 0, $args = array(), $current_page = 0) {
		 ...
		 *        	An array of CSS classes to be applied
		 *        	to each list item.
		 * @param WP_Post $page
		 *        	Page data object.
		 * @param int $depth
		...
		$output .= $indent . sprintf ( '<li class="%s"><a href="%s">%s%s%s</a>', $css_classes, get_permalink ( $page->ID ), $args ['link_before'], /**
