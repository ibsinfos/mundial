 ...
 * @param string $after
 *        	Optional. Priority of the new rule. Accepts 'top'
 ...
 * @param string $query
 *        	Optional. String to append to the rewritten query. Must end in '='. Default empty.
 */
 ...
 *        	Permalink structure.
 * @param array $args
 *        	Optional. Arguments for building the rules from the permalink structure,
 ...
 *        	Optional. Query variables for setting up the loop, as determined in
