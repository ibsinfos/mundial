...
class WP_REST_Response extends WP_HTTP_Response {
	 ...
	 *      
	 * @param string $rel
	 *        	Link relation. Either an IANA registered type,
	 *        	or an absolute URL.
	 * @param string $href
	 *        	Target URI for the link.
	 * @param array $attributes
	 *        	Optional. Link parameters to send along with the URL. Default empty array.
	 */
	 ...
	 * @param string $href
	 *        	Optional. Only remove links for the relation matching the given href.
	 *        	Default null.
	 */
	 ...
	 * @param array $other
	 *        	Optional. Other parameters to send, as an assocative array.
	 *        	Default empty array.
	 */
	...
	/**
	 * Checks if the response is an error, i.e.
	 * >= 400 response code.
	 *
	 * @since 4.4.0
	 * @access public
	...
	public function as_error() {
		...
		if (is_array ( $this->get_data () )) {
			...
			$error->add ( $this->get_status (), '', array (
