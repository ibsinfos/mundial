 ...
 *        	Optional. A post array or a WP_Post object being processed
...
function _wp_post_revision_fields($post = array(), $deprecated = false) {
	 ...
	 *       
	 * @param array $fields
	 *        	List of fields to revision. Contains 'post_title',
 ...
 *        
 * @param array|WP_Post $post
 *        	Optional. A post array or a WP_Post object to be processed
 *        	for insertion as a post revision. Default empty array.
 * @param bool $autosave
 *        	Optional. Is the revision an autosave? Default false.
...
function wp_delete_post_revision($revision_id) {
	...
	if ($delete) {
		 ...
		 * @param int $revision_id
		 *        	Post revision ID.
		 * @param object|array $revision
		 *        	Post revision object or array.
		 */
