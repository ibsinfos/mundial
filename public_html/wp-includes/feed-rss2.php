 ...
 *        	Type of feed. Possible values include 'rss2', 'rss2-comments',
...
<description><?php bloginfo_rss("description") ?></description> <lastBuildDate><?php
$date = get_lastpostmodified ( 'GMT' );
echo $date ? mysql2date ( 'D, d M Y H:i:s +0000', $date, false ) : date ( 'D, d M Y H:i:s +0000' );
?></lastBuildDate> <language><?php bloginfo_rss( 'language' ); ?></language>
<sy:updatePeriod><?php
$duration = 'hourly';
...
?></sy:updatePeriod> <sy:updateFrequency><?php
	 ...
	 *        	An integer passed as a string representing the frequency
