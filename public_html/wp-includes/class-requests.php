...
class Requests {
	...
	public static function add_transport($transport) {
		...
		self::$transports = array_merge ( self::$transports, array (
				$transport 
		) );
	}
	...
	public static function request($url, $headers = array(), $data = array(), $type = self::GET, $options = array()) {
		...
		$options ['hooks']->dispatch ( 'requests.before_request', array (
				&$url,
				&$headers,
				&$data,
				&$type,
		...
		$options ['hooks']->dispatch ( 'requests.before_parse', array (
				&$response,
				$url,
				$headers,
				$data,
	...
	public static function request_multiple($requests, $options = array()) {
		...
		if (! empty ( $options ['hooks'] )) {
			$options ['hooks']->register ( 'transport.internal.parse_response', array (
					'Requests',
					'parse_multiple' 
			) );
		...
		foreach ( $requests as $id => &$request ) {
			...
			if ($request ['options'] ['hooks'] !== $options ['hooks']) {
				$request ['options'] ['hooks']->register ( 'transport.internal.parse_response', array (
						'Requests',
						'parse_multiple' 
				) );
		...
		foreach ( $responses as $id => &$response ) {
			...
			if (is_string ( $response )) {
				...
				$request ['options'] ['hooks']->dispatch ( 'multiple.request.complete', array (
						&$response,
						$id 
				) );
			}
	...
	protected static function parse_response($headers, $url, $req_headers, $req_data, $options) {
		...
		$options ['hooks']->dispatch ( 'requests.before_redirect_check', array (
				&$return,
				$req_headers,
				$req_data,
				$options 
		...
		$options ['hooks']->dispatch ( 'requests.after_request', array (
				&$return,
				$req_headers,
				$req_data,
				$options 
