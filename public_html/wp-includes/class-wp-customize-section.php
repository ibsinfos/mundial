...
class WP_Customize_Section {
	...
	final public function maybe_render() {
		 ...
		 * @since 3.4.0
		 *       
		 * @param WP_Customize_Section $this
		 *        	WP_Customize_Section instance.
		 */
...
<script type="text/html"
	id="tmpl-customize-section-<?php echo $this->type; ?>">
...
<li id="accordion-section-{{ data.id }}"
	...
	<ul class="accordion-section-content">
		<li
			class="customize-section-description-container section-meta <# if ( data.description_hidden ) { #>customize-info<# } #>">
			<div class="customize-section-title">
				...
				<# } #>
			</div> <# if ( data.description && ! data.description_hidden ) { #>
			<div class="description customize-section-description">{{{
				data.description }}}</div> <# } #>
		</li>
	</ul>
