...
function load_textdomain($domain, $mofile) {
	...
	/**
	 * Filters whether to override the .
	 * mo file loading.
	 *
	 * @since 2.9.0
	 *       
 ...
 *        	Optional. Use the $plugin_rel_path parameter instead. Default false.
 ...
 *        	Optional. Relative to `WPMU_PLUGIN_DIR` directory in which the .mo
