 ...
 *        	Optional. Whether to load the option when WordPress starts up. For existing options,
 ...
 *        	Name of option to retrieve. Expected to not be SQL-escaped.
 * @param mixed $default
 *        	Optional value to return if option doesn't exist. Default false.
 ...
 *        	Name of option to retrieve. Expected to not be SQL-escaped.
 * @param mixed $default
 *        	Optional. Value to return if the option doesn't exist. Default false.
 * @return mixed Value set for the option.
 */
function get_network_option($network_id, $option, $default = false) {
	...
	if (isset ( $notoptions [$option] )) {
		 ...
		 *       
		 * @param mixed $default
		 *        	The value to return if the site option does not exist
		 *        	in the database.
		 * @param string $option
		 *        	Option name.
		 * @param int $network_id
...
function get_site_transient($transient) {
	 ...
	 * @since 4.4.0 The `$transient` parameter was added.
	 *       
	 * @param mixed $pre_site_transient
