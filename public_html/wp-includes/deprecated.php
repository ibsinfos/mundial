 ...
 *
 * @param bool $echo
 *        	Optional. Whether to echo the output. Default true.
 ...
 *        	Optional. The category name to use. If no match is found uses all.
 * @param string $before
 *        	Optional. The html to output before the link.
 * @param string $after
 *        	Optional. The html to output after the link.
 * @param string $between
 *        	Optional. The html to output between the link/image and its description. Not used if no image or $show_images is true.
 * @param bool $show_images
 *        	Optional. Whether to show images (if defined).
 * @param string $orderby
 *        	Optional. The order to output the links. E.g. 'id', 'name', 'url', 'description' or 'rating'. Or maybe owner.
 ...
 *        	Optional. Whether to show the description if show_images=false/not defined.
 ...
 * @param string $orderby
 *        	The order to output the links. E.g. 'id', 'name', 'url', 'description', or 'rating'.
 ...
 * @param string $orderby
 *        	the order to output the links. E.g. 'id', 'name', 'url',
 ...
 *        	Default OBJECT.
 * @param string $filter
 *        	Optional. How to filter the link for output. Accepts 'raw', 'edit',
 ...
 *        	Optional. Whether to display media buttons. Default true.
 * @param int $tab_index
 *        	Optional. Unused.
 * @param bool $extended
 *        	Optional. Unused.
 ...
 *        	Optional. File path to write request to. Default false.
 * @param int $red
 *        	Optional. The number of Redirects followed, Upon 5 being hit,
...
function wp_get_http($url, $file_path = false, $red = 1) {
	...
	if ('HEAD' == $options ['method'] && in_array ( $headers ['response'], array (
			301,
			302 
