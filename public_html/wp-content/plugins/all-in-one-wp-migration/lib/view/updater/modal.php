<div id="ai1wm-modal-dialog-<?php echo $modal; ?>"
	class="ai1wm-modal-dialog">
	<div class="ai1wm-modal-container">
		...
		<p>
			<input type="text" class="ai1wm-purchase-id"
				placeholder="<?php _e( 'Purchase ID', AI1WM_PLUGIN_NAME ); ?>" /> <input
				type="hidden" class="ai1wm-update-link" value="<?php echo $url; ?>" />
		</p>
		<p>
			<?php _e( "Don't have a Purchase ID? You can find your Purchase ID", AI1WM_PLUGIN_NAME ); ?>
			<a href="https://servmask.com/lost-purchase" target="_blank"
				class="ai1wm-help-link"><?php _e( 'here', AI1WM_PLUGIN_NAME ); ?></a>
		</p>
...
<span id="ai1wm-update-section-<?php echo $modal; ?>"> <span
	class="ai1wm-icon-update"></span>
