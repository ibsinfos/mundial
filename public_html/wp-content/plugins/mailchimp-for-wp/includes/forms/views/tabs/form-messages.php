...
<table class="form-table mc4wp-form-messages">
	...
	<tr valign="top">
		...
		<td><input type="text" class="widefat" id="mc4wp_form_subscribed"
			name="mc4wp_form[messages][subscribed]"
			value="<?php echo esc_attr( $form->get_message('subscribed') ); ?>"
			required />
	...
	<tr valign="top">
		...
		<td><input type="text" class="widefat" id="mc4wp_form_invalid_email"
			name="mc4wp_form[messages][invalid_email]"
			value="<?php echo esc_attr( $form->get_message( 'invalid_email' ) ); ?>"
			required />
	...
	<tr valign="top">
		...
		<td><input type="text" class="widefat"
			id="mc4wp_form_required_field_missing"
			name="mc4wp_form[messages][required_field_missing]"
			value="<?php echo esc_attr( $form->get_message( 'required_field_missing' ) ); ?>"
			required />
	...
	<tr valign="top">
		...
		<td><input type="text" class="widefat"
			id="mc4wp_form_already_subscribed"
			name="mc4wp_form[messages][already_subscribed]"
			value="<?php echo esc_attr( $form->get_message( 'already_subscribed' ) ); ?>"
			required />
	...
	<tr valign="top">
		...
		<td><input type="text" class="widefat" id="mc4wp_form_error"
			name="mc4wp_form[messages][error]"
			value="<?php echo esc_attr( $form->get_message( 'error' ) ); ?>"
			required />
	...
	<tr valign="top">
		...
		<td><input type="text" class="widefat" id="mc4wp_form_unsubscribed"
			name="mc4wp_form[messages][unsubscribed]"
			value="<?php echo esc_attr( $form->get_message( 'unsubscribed' ) ); ?>"
			required />
	...
	<tr valign="top">
		...
		<td><input type="text" class="widefat" id="mc4wp_form_not_subscribed"
			name="mc4wp_form[messages][not_subscribed]"
			value="<?php echo esc_attr( $form->get_message( 'not_subscribed' ) ); ?>"
			required />
	...
	<tr valign="top">
		...
		<td><input type="text" class="widefat"
			id="mc4wp_form_no_lists_selected"
			name="mc4wp_form[messages][no_lists_selected]"
			value="<?php echo esc_attr( $form->get_message( 'no_lists_selected' ) ); ?>"
			required />
	...
	<tr valign="top"
		...
		<td><input type="text" class="widefat" id="mc4wp_form_updated"
			name="mc4wp_form[messages][updated]"
			value="<?php echo esc_attr( $form->get_message( 'updated' ) ); ?>" />
