...
<div id="mc4wp-admin" class="wrap mc4wp-settings">
	...
	<p class="breadcrumbs">
		...
		<a
			...
			href="<?php echo admin_url( 'admin.php?page=mailchimp-for-wp-forms' ); ?>"><?php _e( 'Forms', 'mailchimp-for-wp' ); ?></a>
		&rsaquo; <span class="current-crumb"><strong><?php echo __( 'Form', 'mailchimp-for-wp' ); ?> <?php echo $form_id; ?> | <?php echo esc_html( $form->name ); ?></strong></span>
	</p>
		...
		<div class="main-content col col-4">
			...
			<form method="post">
				...
				<input type="submit" style="display: none;" /> <input type="hidden"
					name="_mc4wp_action" value="edit_form" /> <input type="hidden"
					name="mc4wp_form_id" value="<?php echo esc_attr( $form->ID ); ?>" />
				...
				<div id="titlediv" class="small-margin">
					<div id="titlewrap">
						...
						<input type="text" name="mc4wp_form[name]" size="30"
							value="<?php echo esc_attr( $form->name ); ?>" id="title"
					...
					<div class="inside" style="margin-top: 3px;">
						...
						<button type="submit" name="_mc4wp_action" value="preview_form"
							...
							onfocus="this.form.setAttribute('target','_form_preview');"
							class="button-secondary" tabindex="-1">
