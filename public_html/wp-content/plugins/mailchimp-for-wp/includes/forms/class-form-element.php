...
class MC4WP_Form_Element {
	...
	/**
	 *
	 * @var array Can be used to set element-specific config settings. Accepts the following keys.
	 *     
	...
	public function __construct(MC4WP_Form $form, $ID, $config = array()) {
		...
		$this->is_submitted = $this->form->is_submitted && $this->form->config ['element_id'] == $this->ID;
	}
	...
	public function get_response_html($force_show = false) {
		 ...
		 *       
		 * @param string $html
		 *        	The complete HTML string of the response, excluding the wrapper element.
		 * @param MC4WP_Form $form
		 *        	The form object
		 */
	 ...
	 *        	Use this to override the configuration for this form element
	 * @return string
	 */
