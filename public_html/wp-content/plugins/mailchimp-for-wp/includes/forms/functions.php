 ...
 *            
 * @param int $form_id
 *        	The ID of the form you want to check. (optional)
 * @param string $element_id
 *        	The ID of the form element you want to check, eg id="mc4wp-form-1" (optional)
 *        	
 * @return boolean
 */
function mc4wp_form_is_submitted($form_id = 0, $element_id = null) {
	...
	if ($element_id) {
		$form_element = new MC4WP_Form_Element ( $form, array (
