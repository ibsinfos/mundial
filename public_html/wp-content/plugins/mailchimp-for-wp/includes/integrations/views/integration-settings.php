...
<div id="mc4wp-admin" class="wrap mc4wp-settings">
	...
	<p class="breadcrumbs">
		...
		<a
			href="<?php echo admin_url( 'admin.php?page=mailchimp-for-wp' ); ?>">MailChimp
			for WordPress</a> &rsaquo; <a
			href="<?php echo admin_url( 'admin.php?page=mailchimp-for-wp-integrations' ); ?>"><?php _e( 'Integrations', 'mailchimp-for-wp' ); ?></a>
		&rsaquo; <span class="current-crumb"><strong><?php echo esc_html( $integration->name ); ?></strong></span>
	</p>
	...
	<div class="main-content row">
		...
		<div class="main-content col col-4 col-sm-6">
			...
			<div id="notice-additional-fields" class="notice notice-info"
				style="display: none;">
			...
			<form method="post"
				...
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td class="nowrap integration-toggles-wrap"><label><input
								type="radio"
								name="mc4wp_integrations[<?php echo $integration->slug; ?>][enabled]"
								value="1" <?php checked( $opts['enabled'], 1 ); ?> /> <?php _e( 'Yes' ); ?></label>
							&nbsp; <label><input type="radio"
								name="mc4wp_integrations[<?php echo $integration->slug; ?>][enabled]"
								value="0" <?php checked( $opts['enabled'], 0 ); ?> /> <?php _e( 'No' ); ?></label>
					...
					<?php if( $integration->has_ui_element( 'implicit' ) ) { ?>
						<tr valign="top">
							...
							<td class="nowrap"><label><input type="radio"
									name="mc4wp_integrations[<?php echo $integration->slug; ?>][implicit]"
									value="1" <?php checked( $opts['implicit'], 1 ); ?> /> <?php _e( 'Yes' ); ?></label>
								&nbsp; <label><input type="radio"
									name="mc4wp_integrations[<?php echo $integration->slug; ?>][implicit]"
									value="0" <?php checked( $opts['implicit'], 0 ); ?> /> <?php _e( 'No' ); ?></label>
...
if ($integration->has_ui_element ( 'lists' )) {
						...
						<input type="hidden"
							name="mc4wp_integrations[<?php echo $integration->slug; ?>][lists][]"
							value="" />
						<tr valign="top">
...
if ($integration->has_ui_element ( 'label' )) {
						...
						<tr valign="top"
							...
							<td><input type="text" class="widefat" id="mc4wp_checkbox_label"
...
if ($integration->has_ui_element ( 'precheck' )) {
						...
						<tr valign="top"
							...
							<td class="nowrap"><label><input type="radio"
									...
									value="1" <?php checked( $opts['precheck'], 1 ); ?> /> <?php _e( 'Yes' ); ?></label>
								&nbsp; <label><input type="radio"
									name="mc4wp_integrations[<?php echo $integration->slug; ?>][precheck]"
									value="0" <?php checked( $opts['precheck'], 0 ); ?> /> <?php _e( 'No' ); ?></label>
...
if ($integration->has_ui_element ( 'css' )) {
						...
						<tr valign="top"
							...
							<td class="nowrap"><label><input type="radio"
									...
									value="1" <?php checked( $opts['css'], 1 ); ?> />&rlm; <?php _e( 'Yes' ); ?></label>
								&nbsp; <label><input type="radio"
									name="mc4wp_integrations[<?php echo $integration->slug; ?>][css]"
									value="0" <?php checked( $opts['css'], 0 ); ?> />&rlm; <?php _e( 'No' ); ?></label>
					...
					<?php if( $integration->has_ui_element( 'double_optin' ) ) { ?>
						<tr valign="top">
							...
							<td class="nowrap"><label> <input type="radio"
									...
									value="1" <?php checked( $opts['double_optin'], 1 ); ?> />&rlm;
									<?php _e( 'Yes' ); ?>
								</label> &nbsp; <label> <input type="radio"
									id="mc4wp_checkbox_double_optin_0"
									name="mc4wp_integrations[<?php echo $integration->slug; ?>][double_optin]"
									value="0" <?php checked( $opts['double_optin'], 0 ); ?> />&rlm;
									<?php _e( 'No' ); ?>
								</label>
								<p class="help">
					...
					<tr valign="top">
							...
							<td class="nowrap"><label> <input type="radio"
									...
									value="1" <?php checked( $opts['update_existing'], 1 ); ?> />&rlm;
								<?php _e( 'Yes' ); ?>
							</label> &nbsp; <label> <input type="radio"
									name="mc4wp_integrations[<?php echo $integration->slug; ?>][update_existing]"
									value="0" <?php checked( $opts['update_existing'], 0 ); ?> />&rlm;
								<?php _e( 'No' ); ?>
							</label>
...
if ($integration->has_ui_element ( 'replace_interests' )) {
						...
						<tr valign="top"
							...
							<td class="nowrap"><label> <input type="radio"
									...
									value="1" <?php checked( $opts['replace_interests'], 1 ); ?> />&rlm;
									<?php _e( 'Yes' ); ?>
								</label> &nbsp; <label> <input type="radio"
									name="mc4wp_integrations[<?php echo $integration->slug; ?>][replace_interests]"
									value="0" <?php checked( $opts['replace_interests'], 0 ); ?> />&rlm;
									<?php _e( 'No' ); ?>
								</label>
								<p class="help">
