...
foreach ( $integrations as $integration ) {
		...
		?>
			...
			<td>
					...
					<?php
		if ($installed) {
			printf ( '<strong><a href="%s" title="%s">%s</a></strong>', add_query_arg ( array (
...
<div id="mc4wp-admin" class="wrap mc4wp-settings">
	...
	<p class="breadcrumbs">
		...
		<a
			...
			for WordPress</a> &rsaquo; <span class="current-crumb"><strong><?php _e( 'Integrations', 'mailchimp-for-wp' ); ?></strong></span>
	</p>
