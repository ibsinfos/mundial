...
class MC4WP_Integration_Admin {
	...
	public function register_setting() {
		register_setting ( 'mc4wp_integrations_settings', 'mc4wp_integrations', array (
				$this,
	...
	public function enqueue_assets($suffix, $page = '') {
		...
		wp_register_script ( 'mc4wp-integrations-admin', MC4WP_PLUGIN_URL . 'assets/js/integrations-admin' . $suffix . '.js', array (
				'mc4wp-admin' 
		), MC4WP_VERSION, true );
