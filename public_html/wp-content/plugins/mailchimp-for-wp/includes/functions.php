...
function mc4wp_get_debug_log() {
	 ...
	 *
	 * @param string $file
	 *        	The log file location. Default: /wp-content/uploads/mc4wp-debug.log
	 */
 ...
 *
 * @param $string String
 *        	possibly containing email address
 * @return string
 */
...
/**
 * Refreshes MailChimp lists.
 * This can take a while if the connected MailChimp account has many lists.
 *
 * @return void
 */
