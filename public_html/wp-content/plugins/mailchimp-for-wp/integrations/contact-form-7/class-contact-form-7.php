...
class MC4WP_Contact_Form_7_Integration extends MC4WP_Integration {
	...
	public function add_hooks() {
		add_action ( 'wpcf7_init', array (
				$this,
				'init' 
		) );
		add_action ( 'wpcf7_mail_sent', array (
				$this,
				'process' 
		), 1 );
		add_action ( 'wpcf7_posted_data', array (
				$this,
				'alter_cf7_data' 
		) );
	}
	...
	public function init() {
		if (function_exists ( 'wpcf7_add_form_tag' )) {
			wpcf7_add_form_tag ( 'mc4wp_checkbox', array (
					$this,
					'shortcode' 
			) );
		} else {
			wpcf7_add_shortcode ( 'mc4wp_checkbox', array (
					$this,
					'shortcode' 
			) );
		}
	...
	public function checkbox_was_checked() {
		...
		return (isset ( $data [$this->checkbox_name] ) && $data [$this->checkbox_name] == 1) || (isset ( $data ['mc4wp-subscribe'] ) && $data ['mc4wp-subscribe'] == 1);
	}
	...
	public function get_ui_elements() {
		return array_diff ( parent::get_ui_elements (), array (
				'enabled',
				'implicit' 
		) );
	}
