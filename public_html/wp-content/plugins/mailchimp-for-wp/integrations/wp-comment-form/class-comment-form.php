...
class MC4WP_Comment_Form_Integration extends MC4WP_Integration {
	...
	public function add_hooks() {
		if (! $this->options ['implicit']) {
			...
			add_filter ( 'comment_form_submit_field', array (
					$this,
					'add_checkbox_before_submit_button' 
			), 90 );
			
			add_action ( 'thesis_hook_after_comment_box', array (
					$this,
					'maybe_output_checkbox' 
			), 90 );
