...
function wpcf7_add_form_tag_quiz() {
	wpcf7_add_form_tag ( 'quiz', 'wpcf7_quiz_form_tag_handler', array (
			'name-attr' => true,
			'do-not-store' => true 
	) );
}
...
function wpcf7_add_tag_generator_quiz() {
	...
	$tag_generator->add ( 'quiz', __ ( 'quiz', 'contact-form-7' ), 'wpcf7_tag_generator_quiz' );
}
					...
					<td>
						<fieldset>
							...
							<br /> <label
								...
								class="description"><?php echo esc_html( __( "One pipe-separated question-answer pair (e.g. The capital of Brazil?|Rio) per line.", 'contact-form-7' ) ); ?></span></label>
						</fieldset>
					</td>
				</tr>
