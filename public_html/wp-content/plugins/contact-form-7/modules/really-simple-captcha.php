...
function wpcf7_add_form_tag_captcha() {
	...
	wpcf7_add_form_tag ( 'captchac', 'wpcf7_captchac_form_tag_handler', array (
			'name-attr' => true 
	) );
	
	// CAPTCHA-Response (input)
	wpcf7_add_form_tag ( 'captchar', 'wpcf7_captchar_form_tag_handler', array (
			'name-attr' => true,
			'do-not-store' => true 
	) );
}
...
function wpcf7_captcha_ajax_refill($items) {
	...
	$fes = wpcf7_scan_form_tags ( array (
			'type' => 'captchac' 
	) );
	...
	<fieldset>
		...
		<table class="form-table scope captchac">
			...
			<tbody>
				<tr>
					<th scope="row"><label
						for="<?php echo esc_attr( $args['content'] . '-captchac-id' ); ?>"><?php echo esc_html( __( 'Id attribute', 'contact-form-7' ) ); ?></label></th>
				...
				<tr>
					<th scope="row"><label
						for="<?php echo esc_attr( $args['content'] . '-captchac-class' ); ?>"><?php echo esc_html( __( 'Class attribute', 'contact-form-7' ) ); ?></label></th>
		...
		<table class="form-table scope captchar">
			...
			<tbody>
				<tr>
					<th scope="row"><label
						for="<?php echo esc_attr( $args['content'] . '-captchar-id' ); ?>"><?php echo esc_html( __( 'Id attribute', 'contact-form-7' ) ); ?></label></th>
					<td><input type="text" name="id" class="idvalue oneline option"
				...
				<tr>
					<th scope="row"><label
						for="<?php echo esc_attr( $args['content'] . '-captchar-class' ); ?>"><?php echo esc_html( __( 'Class attribute', 'contact-form-7' ) ); ?></label></th>
					<td><input type="text" name="class"
						class="classvalue oneline option"
...
<div class="insert-box">
	<input type="text" name="captcha" class="tag code" readonly="readonly"
		onfocus="this.select()" />
