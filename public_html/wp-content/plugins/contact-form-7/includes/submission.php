...
class WPCF7_Submission {
	...
	private function setup_posted_data() {
		...
		$posted_data = array_diff_key ( $posted_data, array (
				'_wpcf7_nonce' => '' 
		) );
	...
	private function submit() {
		...
		$this->meta = array (
				...
				'container_post_id' => isset ( $_POST ['_wpcf7_container_post'] ) ? ( int ) $_POST ['_wpcf7_container_post'] : 0 
		);
	...
	private function get_request_url() {
		...
		$url = preg_replace ( '%(?<!:|/)/.*$%', '', $home_url ) . wpcf7_get_request_uri ();
	...
	private function verify_nonce() {
		return wpcf7_verify_nonce ( $_POST ['_wpcf7_nonce'], $this->contact_form->id () );
	}
