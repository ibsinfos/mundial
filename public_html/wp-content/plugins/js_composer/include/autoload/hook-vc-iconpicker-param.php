...
function vc_iconpicker_base_register_js() {
	wp_register_script ( 'vc-icon-picker', vc_asset_url ( 'lib/bower/vcIconPicker/jquery.fonticonpicker.min.js' ), array (
			'jquery' 
	), WPB_VC_VERSION );
}

/**
 * Enqueue ALL fonts/styles for Editor(admin) mode.
 * (to allow easy change icons)
