...
class Vc_Settings_Preset {
	 ...
	 *
	 * @param int $id
	 *        	If falsy, no default will be set
	 * @param string $shortcode_name        	
	 *
	 * @return boolean
	 *
	 ...
	 *       
	 * @param mixed $id
	 *        	Can be int (user preset) or string (vendor preset)
	 * @param bool $array
	 *        	If true, return array instead of string
	 *        	
	 ...
	 *       
	 * @param int $post_id
	 *        	Post must be of type 'vc_settings_preset'
	 *        	
	 * @return bool
	 */
