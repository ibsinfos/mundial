	...
	<div class="vc_ui-panel-header">
		<div class="vc_ui-panel-header-controls">
			<?php foreach ( $controls as $key => $control ) :  ?>
				...
				<?php else : ?>
					<button type="button"
				class="vc_general vc_ui-control-button vc_ui-<?php echo esc_attr( $control ) ?>-button"
				data-vc-ui-element="button-<?php echo esc_attr( $control ) ?>">
				<i
		...
		<div class="vc_ui-panel-header-content"
			data-vc-ui-element="panel-header-content">
