...
?>
<div id="vc_templates-editor" class="vc_panel vc_templates-editor"
	style="display: none;">
	<div class="vc_panel-heading">
		<a title="<?php _e( 'Close panel', 'js_composer' ); ?>" href="#"
			class="vc_close" data-dismiss="panel" aria-hidden="true"><i
			class="vc_icon"></i></a> <a
			title="<?php _e( 'Hide panel', 'js_composer' ); ?>" href="#"
			class="vc_transparent" data-transparent="panel" aria-hidden="true"><i
			class="vc_icon"></i></a>

		<h3 class="vc_panel-title"><?php _e( 'Templates', 'js_composer' ) ?></h3>
	</div>
	<div
		class="vc_panel-body vc_templates-body vc_properties-list vc_with-tabs">
...
$templates = apply_filters ( 'vc_load_default_templates_panels', $box->loadDefaultTemplates () );
					...
					<div class="vc_edit-form-tab" id="tabs-templates-tabs-1"
						...
						<div class="vc_col-sm-12 vc_column inside">
							...
							<div class="edit_form_line">
								<input name="padding" class="wpb-textinput vc_title_name"
									type="text" value="" id="vc_template-name"
							...
							<span class="vc_description"><?php _e( 'Save layout and reuse it on different sections of this site.', 'js_composer' ) ?></span>
						</div>
						<div class="vc_col-sm-12 vc_column">
							<div class="wpb_element_label"><?php _e( 'Load Template', 'js_composer' ) ?></div>
							<span class="vc_description"><?php _e( 'Append previosly saved template to the current layout', 'js_composer' ) ?></span>
						...
						<div class="vc_col-sm-12 vc_column inside">
							...
							<ul id="vc_default-template-list" class="wpb_templates_list">
									<?php foreach ( $templates as $key => $template ) :  ?>
										<li class="wpb_template_li" data-vc-ui-element="template"><a
									href="#" data-template_name="<?php echo $key ?>"
