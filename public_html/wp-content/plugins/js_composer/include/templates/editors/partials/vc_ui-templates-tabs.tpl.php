...
foreach ( $categories as $key => $value ) :
		echo '<li' . ' class="vc_panel-tabs-control' . ($first ? ' vc_active' : '') . '"><button data-vc-ui-element-target="[data-tab=' . trim ( esc_attr ( $key ) ) . ']" class="vc_ui-tabs-line-trigger" data-vc-ui-element="panel-tab-control">' . esc_html ( $value ) . '</button>';
		echo '</li>';
		$first = false;
	endforeach
	;
