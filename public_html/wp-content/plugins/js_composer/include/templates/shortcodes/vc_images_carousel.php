 ...
 * @var $partial_view
 * @var $css
 * @var $css_animation Shortcode class
						...
						<?php foreach ( $images as $attach_id ) :  ?>
							...
							<div class="vc_inner">
									<?php if ( 'link_image' === $onclick ) :  ?>
										...
										<a class="prettyphoto" href="<?php echo $p_img_large[0] ?>"
									<?php echo $pretty_rand; ?>>
											<?php echo $thumbnail?>
										</a>
									<?php elseif ( 'custom_link' === $onclick && isset( $custom_links[ $i ] ) && '' !== $custom_links[ $i ] ) :  ?>
										<a href="<?php echo $custom_links[ $i ] ?>"
									<?php echo( ! empty( $custom_links_target ) ? ' target="' . $custom_links_target . '"' : '' ) ?>>
											<?php echo $thumbnail?>
										</a>
									<?php else : ?>
										<?php echo $thumbnail?>
