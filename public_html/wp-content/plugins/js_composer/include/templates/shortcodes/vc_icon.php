...
<div <?php echo implode( ' ', $wrapper_attributes ); ?>
	class="vc_icon_element vc_icon_element-outer<?php echo strlen( $css_class ) > 0 ? ' ' . trim( esc_attr( $css_class ) ) : ''; ?> vc_icon_element-align-<?php
...
echo esc_attr ( $align );
	...
	?>">
	<div
		class="vc_icon_element-inner vc_icon_element-color-<?php
...
echo esc_attr ( $color );
		...
		<?php echo $style ?>>
		<span class="vc_icon_element-icon <?php echo $iconClass; ?>"
