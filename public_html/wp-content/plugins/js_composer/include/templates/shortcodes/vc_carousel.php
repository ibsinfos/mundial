 ...
 * @var $thumb_size
 * @var $partial_view
 * @var $title Shortcode class
 * @var $this WPBakeryShortCode_Vc_Carousel
 */
$el_class = $posts_query = $mode = $speed = $slides_per_view = $wrap = $autoplay = $hide_pagination_control = $hide_prev_next_buttons = $layout = $link_target = $thumb_size = $partial_view = $title = '';
...
<div
	...
	<div class="wpb_wrapper">
		...
		<div id="<?php echo $carousel_id ?>" data-ride="vc_carousel"
			...
			data-auto-height="true" data-mode="<?php echo $mode ?>"
			data-partial="<?php echo 'yes' === $partial_view ? 'true' : 'false' ?>"
			data-per-view="<?php echo $slides_per_view ?>"
			data-hide-on-end="<?php echo 'yes' === $autoplay ? 'false' : 'true' ?>"
			class="vc_carousel vc_slide">
				...
				<div class="vc_carousel-slideline">
					<div class="vc_carousel-slideline-inner">
						<?php foreach ( $posts as $post ) :  ?>
							...
							?>
							<div class="vc_item vc_slide_<?php echo $post->post_type ?>"
			...
			<a class="vc_left vc_carousel-control"
				href="#<?php echo $carousel_id ?>" data-slide="prev"> <span
				class="icon-prev"></span>
			</a> <a class="vc_right vc_carousel-control"
				href="#<?php echo $carousel_id ?>" data-slide="next"> <span
