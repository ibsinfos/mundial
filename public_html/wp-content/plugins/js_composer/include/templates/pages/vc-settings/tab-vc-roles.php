...
<form action="<?php echo admin_url( 'admin-ajax.php' ); ?>"
	method="post" id="vc_settings-<?php echo $tab ?>"
...
foreach ( $editable_roles as $role => $details ) :
				...
				<div class="widget" data-vc-accordion=""
					...
					<div class="widget-top">
						<div class="widget-title-action">
							<a class="widget-action hide-if-no-js" href="#"></a> <a
								class="widget-control-edit hide-if-js"> <span
								class="edit vc_automapper-edit-btn">Edit</span> <span
								class="add vc_automapper-delete-btn">Add</span> <span
	...
	<span class="vc_settings-spinner vc_ui-wp-spinner"
		style="display: none;" id="vc_wp-spinner"></span>
