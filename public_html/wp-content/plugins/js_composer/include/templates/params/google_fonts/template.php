	...
	<div class="vc_google_fonts_form_field-font_family-container">
		<select class="vc_google_fonts_form_field-font_family-select"
			...
			foreach ( $fonts as $font_data ) :
				?>
				<option
				value="<?php echo $font_data->font_family . ':' . $font_data->font_styles; ?>"
				...
				class="<?php echo vc_build_safe_css_class( $font_data->font_family ); ?>"
				<?php echo( strtolower( $values['font_family'] ) == strtolower( $font_data->font_family ) || strtolower( $values['font_family'] ) == strtolower( $font_data->font_family ) . ':' . $font_data->font_styles ? 'selected' : '' ); ?>><?php echo $font_data->font_family ?></option>
			<?php endforeach ?>
		</select>
	</div>
...
<div
	class="vc_row-fluid vc_column vc_google_fonts_form_field-preview-wrapper">
	...
	<div class="vc_google_fonts_form_field-status-container">
		<span></span>
	</div>
</div>

<input name="<?php echo $settings['param_name']; ?>"
	class="wpb_vc_param_value  <?php echo $settings['param_name'] . ' ' . $settings['type']; ?>_field"
