...
class Vc_Color_Helper {
	 ...
	 * If no desired amount provided, then the color halfway between
	...
	/**
	 * Given a HEX value, returns a mixed color.
	 * If no desired amount provided, then the color mixed by this ratio
	 *
	 * @param string $hex2
