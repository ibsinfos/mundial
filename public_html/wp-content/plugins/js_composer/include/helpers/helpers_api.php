...
if (! function_exists ( 'vc_set_default_editor_post_types' )) {
	 ...
	 *       
	 * @param array $list
	 *        	- list of valid post types to set
	 */
...
if (! function_exists ( 'vc_set_shortcodes_templates_dir' )) {
	 ...
	 *       
	 * @param
	 *        	string - full directory path to new template directory with trailing slash
	 */
...
if (! function_exists ( 'vc_add_default_templates' )) {
	 ...
	 *
	 * @param array $data
	 *        	| template data (name, content, custom_class, image_path)
	 *        	
	 * @since 4.3
	 * @return bool
	 */
