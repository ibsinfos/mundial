...
class Vc_Templates_Editor implements Vc_Render {
	...
	public function init() {
		...
		add_action ( 'wp_ajax_wpb_save_template', array (
				&$this,
				'save' 
		) );
		add_action ( 'wp_ajax_vc_backend_template', array (
				&$this,
				'load' 
		) );
		...
		add_action ( 'wp_ajax_wpb_delete_template', array (
				&$this,
				'delete' 
		) );
	}
	 ...
	 *            
	 * @param bool $return
	 *        	| should function return data or not
	 *        	
	 * @return string
	 */
