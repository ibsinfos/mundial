...
class Vc_Edit_Form_Fields implements Vc_Render {
	 ...
	 *        	shortcode tag
	 * @param $atts -
	 *        	list of attribute assign to the shortcode.
	 */
	...
	public function render() {
		...
		if (in_array ( $this->tag, array (
				'vc_row' 
		) ) && vc_user_access ()->part ( 'templates' )->can ()->get ()) {
			$show_settings = true;
		}
	 ...
	 *        	vc_single_param_edit - hook to edit any shortode param
