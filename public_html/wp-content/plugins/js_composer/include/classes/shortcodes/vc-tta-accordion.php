...
class WPBakeryShortCode_VC_Tta_Accordion extends WPBakeryShortCodesContainer {
	 ...
	 *        	If true, check for min/max bounds
	 *        	
	...
	public function enqueueTtaScript() {
		...
		wp_register_script ( 'vc_tta_autoplay_script', vc_asset_url ( 'lib/vc-tta-autoplay/vc-tta-autoplay.min.js' ), array (
				'vc_accordion_script' 
		), WPB_VC_VERSION, true );
	...
	/**
	 * Override default outputTitle (also Icon).
	 * To remove anything, also Icon.
	 *
	 * @param $title -
	 *        	just for strict standards
	 *        	
	 * @return string
	 */
