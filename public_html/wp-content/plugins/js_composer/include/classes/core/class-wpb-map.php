...
class WPBMap {
	 ...
	 *
	 * @param bool $force
	 *        	- force data generation even data already generated.
	 */
	 ...
	 *        	shortcode' name.
	 * @param $setting_name -
	 *        	option key name or the array of options.
	 * @param $value -
	 *        	value of settings if $setting_name is option key.
	 *        	
	 * @return array|bool
	 */
	...
	/**
	 * Sorting method for WPBMap::generateUserData method.
	 * Called by uasort php function.
	 * 
