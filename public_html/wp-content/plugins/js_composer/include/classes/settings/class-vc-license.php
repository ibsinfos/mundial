...
class Vc_License {
	 ...
	 * @var string
	 */
	protected static $support_host = 'http://support.wpbakery.com';
	 ...
	 *
	 * @param string $host
	 *        	Hostname to check. If null, use HTTP_HOST
	 *        	
	 * @return boolean
	 */
...
<?php
	 ...
	 *        	SHA1 hashed token
	 * @param int $ttl_in_seconds
	 *        	Time to live in seconds. Default = 20min
	 *        	
	 * @return boolean
	 */
