...
class Vc_Manager {
	 ...
	 * @var array
	 */
	private $editor_default_post_types = array (
			'page' 
	...
	/**
	 * Callback function WP plugin_loaded action hook.
	 * Loads locale
	 *
	 * @since 4.2
	 * @access public
	 ...
	 * Sets Vc mode and loads required objects.
	 *
	 * @since 4.2
	 * @access public
	 *        
	 ...
	 *        	name of path dir
	 * @param string $file
	 *        	- file name or directory inside path
	 *        	
	 * @return string
	 */
	 ...
	 * Vc editors are enabled for such kind of posts.
	 *
	 * @param array $type
	 *        	- list of default post types.
	 */
	 ...
	 *        
	 * @param $dir -
	 *        	path to shortcodes templates inside developers theme
	 */
