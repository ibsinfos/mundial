...
class Rev_addon_Admin {
	...
	public function enqueue_scripts() {
		...
		if (isset ( $_GET ["page"] ) && $_GET ["page"] == "rev_addon") {
			...
			wp_enqueue_script ( $this->plugin_name, RS_PLUGIN_URL . 'admin/assets/js/rev_addon-admin.js', array (
					'jquery' 
			), $this->version, false );
	...
	public function add_plugin_admin_menu() {
		$this->plugin_screen_hook_suffix = add_submenu_page ( 'revslider', __ ( 'Add-Ons', 'revslider' ), __ ( 'Add-Ons', 'revslider' ), 'manage_options', $this->plugin_name, array (
				$this,
