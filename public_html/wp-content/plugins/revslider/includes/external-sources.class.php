...
class RevSliderFacebook {
	 ...
	 *        	Facebook User id (not name)
	 * @param int $item_count
	 *        	number of photos to pull
	 */
...
class RevSliderTwitter {
	 ...
	 *        	Twitter App Registration Consomer Key
	 * @param string $consumer_secret
	 *        	Twitter App Registration Consomer Secret
	 * @param string $access_token
	 *        	Twitter App Registration Access Token
	 * @param string $access_token_secret
	 *        	Twitter App Registration Access Token Secret
	 */
	 ...
	 *        	Twitter account without trailing @ char
	 */
...
class RevSliderTwitterApi {
	 ...
	 *      
	 * @param string $query
	 *        	Insert the query in the format "count=1&include_entities=true&include_rts=true&screen_name=micc1983!
	 * @param array $query_args
	 *        	Array of arguments: Resource type (string) and cache duration (int)
	 * @param bool $stop
	 *        	Stop the query to avoid infinite loop
	 *        	
	 ...
	 *        	Error message
	 * @param string $error_object
	 *        	Server response or wp_error
	 */
...
class RevSliderFlickr {
	 ...
	 * @since 1.0.0
	 * @param array $params
	 *        	Parameter build for API request
	 */
