...
<div id="rev_lang_list">
	<div
		class="slide_langs_selector editor_buttons_wrapper  postbox unite-postbox"
		...
		<div class="slide-main-settings-form" style="padding: 15px;">
			...
			<ul class="list_slide_icons"
				style="display: inline-block; vertical-align: middle; margin-bottom: 0px;">
				<?php
				...
				foreach ( $arrChildLangs as $arrLang ) {
					...
					?>
					<li class="<?php echo $class; ?>"><img
					id="icon_lang_<?php echo $childSlideID; ?>" class="icon_slide_lang"
				...
				<li>
					<div id="icon_add_lang_<?php echo $slideID; ?>"
						...
						data-origid="<?php echo $parent_id; ?>"
