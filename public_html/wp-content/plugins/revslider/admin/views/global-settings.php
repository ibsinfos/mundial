...
<div class='wrap'>
	...
	<div id="rs-global-settings-dialog-wrap">
		<form name="form_general_settings" id="form_general_settings">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="includes_globally_1"
						name="includes_globally" class="tp-moderncheckbox"
						data-unchecked="off" <?php checked($includes_globally, "on");?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="text" class="regular-text" id="pages_for_includes"
						name="pages_for_includes"
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="js_to_footer_1" name="js_to_footer"
						class="tp-moderncheckbox" data-unchecked="off"
						<?php checked($js_to_footer, 'on'); ?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="js_defer_1" name="js_defer"
						class="tp-moderncheckbox" data-unchecked="off"
						<?php checked($js_defer, 'on'); ?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="load_all_javascript_1"
						name="load_all_javascript" class="tp-moderncheckbox"
						data-unchecked="off" <?php checked($load_all_javascript, 'on'); ?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="show_dev_export_1"
						name="show_dev_export" class="tp-moderncheckbox"
						data-unchecked="off" <?php checked($show_dev_export, 'on'); ?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input id="change_font_loading" name="change_font_loading"
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="" name="stage_collapse"
						class="tp-moderncheckbox" data-unchecked="off"
						<?php checked($stage_collapse, 'on'); ?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="" name="enable_newschannel"
						class="tp-moderncheckbox" data-unchecked="off"
						<?php checked($enable_newschannel, 'on'); ?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="enable_logs_1" name="enable_logs"
						class="tp-moderncheckbox" data-unchecked="off"
						<?php checked($enable_logs, 'on'); ?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="" name="force_activation_box"
						class="tp-moderncheckbox" data-unchecked="off"
						<?php checked($force_activation_box, 'on'); ?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="" name="pack_page_creation"
						class="tp-moderncheckbox" data-unchecked="off"
						<?php checked($pack_page_creation, 'on'); ?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<input type="checkbox" id="" value="on" name="single_page_creation"
						class="tp-moderncheckbox" data-unchecked="off"
						<?php checked($single_page_creation, 'on'); ?>>
				</div>
				<div class="rs-gs-tc">
			...
			<div class="rs-global-setting">
				...
				<div class="rs-gs-tc">
					<a id="trigger_database_creation" class="button-primary revblue"
						original-title="" href="javascript:void(0);"><?php _e('Go!', 'revslider'); ?></a>
				</div>
				<div class="rs-gs-tc">
	...
	<p>
		<a id="button_save_general_settings" class="button-primary revgreen"
			original-title=""><?php _e('Save Settings', 'revslider'); ?></a>
	</p>
	<span id="loader_general_settings" class="loader_round mleft_10"
