...
class RWMB_Select_Tree_Field extends RWMB_Select_Field {
	 ...
	 *        	Database fields to use in the output.
	 * @param mixed $meta
	 *        	Meta value.
	 *        	
	 * @return string
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_style ( 'rwmb-select-tree', RWMB_CSS_URL . 'select-tree.css', array (
				'rwmb-select' 
		), RWMB_VER );
		wp_enqueue_script ( 'rwmb-select-tree', RWMB_JS_URL . 'select-tree.js', array (
				'rwmb-select' 
		), RWMB_VER, true );
	}
