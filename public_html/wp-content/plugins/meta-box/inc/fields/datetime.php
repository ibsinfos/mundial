...
class RWMB_Datetime_Field extends RWMB_Text_Field {
	...
	public static function admin_register_scripts() {
		...
		wp_register_style ( 'rwmb-date', RWMB_CSS_URL . 'datepicker.css', array (
		...
		wp_register_script ( 'jquery-ui-timepicker-i18n', "$url/jquery-ui-timepicker-addon-i18n.min.js", array (
		...
		wp_register_script ( 'rwmb-time', RWMB_JS_URL . 'time.js', array (
				'jquery-ui-timepicker-i18n' 
		), RWMB_VER, true );
	 ...
	 *        	The post ID.
	 * @param bool $saved
	 *        	Whether the meta box is saved at least once.
	 * @param array $field
	 *        	The field parameters.
	 *        	
	 * @return mixed
	...
	public static function translate_format($field) {
		return strtr ( $field ['js_options'] ['dateFormat'], self::$date_formats ) . $field ['js_options'] ['separator'] . strtr ( $field ['js_options'] ['timeFormat'], self::$time_formats );
	}
}
