...
class RWMB_File_Input_Field extends RWMB_Input_Field {
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_media ();
		wp_enqueue_script ( 'rwmb-file-input', RWMB_JS_URL . 'file-input.js', array (
				'jquery' 
		), RWMB_VER, true );
	...
	public static function html($meta, $field) {
		...
		return sprintf ( '<input %s>
			...
			<a href="#" class="rwmb-file-input-remove button %s">%s</a>', self::render_attributes ( $attributes ), esc_html__ ( 'Select', 'meta-box' ), $meta ? '' : 'hidden', esc_html__ ( 'Remove', 'meta-box' ) );
	}
