...
abstract class RWMB_Field {
	...
	public static function begin_html($meta, $field) {
		$field_label = '';
		if ($field ['name']) {
			$field_label = sprintf ( '<div class="rwmb-label">
					<label for="%s">%s</label>
					%s
	 ...
	 *        	Field parameters.
	 * @param array $args
	 *        	Arguments of {@see rwmb_meta()} helper.
	 *        	
	 * @return mixed
	 */
	...
	public static function get_attributes($field, $value = null) {
		...
		$attributes ['class'] = implode ( ' ', array_merge ( array (
				"rwmb-{$field['type']}" 
	 ...
	 * Sub-fields should overwrite this method if necessary.
	 *
	 * @param array $field
	 *        	Field parameters.
	 * @param string $value
	...
	public static function map_types($field) {
		...
		$type_map = apply_filters ( 'rwmb_type_map', array (
				'file_advanced' => 'media',
