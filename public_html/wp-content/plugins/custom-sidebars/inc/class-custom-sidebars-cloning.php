...
<div class="csb-clone csb-clone-<?php echo esc_attr( $widget->id ); ?>">
		 ...
		 */
		?>
		<input type="hidden" name="csb-clone-button" value="0" /> <input
		type="hidden" name="csb_clone[group]" class="csb-clone-group"
		value="<?php echo esc_attr( $data['group'] ); ?>" /> <input
		type="hidden" name="csb_clone[state]" class="csb-clone-state"
		value="<?php echo esc_attr( $data['state'] ); ?>" />
...
<?php
	...
	/**
	 * This function returns the $instance data of a new clone.
	 * The data is
