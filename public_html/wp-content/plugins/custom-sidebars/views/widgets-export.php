...
<div class="wpmui-form module-export">
	...
	<form class="frm-export">
		...
		<p>
			...
			<?php
			_e ( 'This will generate a complete export file containing all ' . 'your sidebars and the current sidebar configuration.', 'custom-sidebars' );
			?>
		</p>
		<p>
			<label for="description"><?php _e( 'Optional description for the export file:', 'custom-sidebars' ); ?></label><br />
			<textarea id="description" name="export-description" placeholder=""
