...
<img src="<?php echo esc_url( CSB_IMG_URL . 'frontpage-info.png' ); ?>"
	style="width: 274px; margin: 0 0 -14px -10px;" />

<?php foreach ( $sidebars as $s ) { ?>
<input type="hidden" name="cs_replacement_<?php echo esc_attr( $s ); ?>"
...
<p>
	<label for="cs_replacement_<?php echo esc_attr( $s ); ?>"> <b><?php echo esc_html( $sb_name ); ?></b>:
	</label> <select name="cs_replacement_<?php echo esc_attr( $s ); ?>"
