...
<?php wp_nonce_field( 'custom-sidebars-edit-sidebar' ); ?>
	<div class="wpmui-grid-8 no-pad-top">
		<div class="col-3">
			...
			<input type="text" name="name" id="csb-name" maxlength="40"
				placeholder="<?php _e( 'Sidebar name here...', 'custom-sidebars' ); ?>" />
		...
		<div class="col-5">
			...
			<input type="text" name="description" id="csb-description"
				maxlength="200"
				placeholder="<?php _e( 'Sidebar description here...', 'custom-sidebars' ); ?>" />
		</div>
	</div>
...
_e ( 'Before-after title-widget properties define the html code that will wrap ' . 'the widgets and their titles in the sidebars, more info about them on the ' . '<a href="http://justintadlock.com/archives/2010/11/08/sidebars-in-wordpress" target="_blank">Justin ' . 'Tadlock Blog</a>. Do not use these fields if you are not sure what you are doing, it can break ' . 'the design of your site. Leave these fields blank to use the theme sidebars design.', 'custom-sidebars' );
	...
	<div class="buttons">
		<label for="csb-more" class="wpmui-left"> <input type="checkbox"
			id="csb-more" />
