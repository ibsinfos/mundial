	...
	<div class="have-key">
		...
		<?php if ( $stat_totals && isset( $stat_totals['all'] ) && (int) $stat_totals['all']->spam > 0 ) : ?>
			...
			<iframe allowtransparency="true" scrolling="no" frameborder="0"
				...
				src="<?php printf( '//akismet.com/web/1.0/snapshot.php?blog=%s&api_key=%s&height=180&locale=%s', urlencode( get_option( 'home' ) ), Akismet::get_api_key(), get_locale() );?>"></iframe>
			<ul>
				<li>
				...
				<li>
					<h3><?php esc_html_e( 'Accuracy' , 'akismet');?></h3> <span><?php echo floatval( $stat_totals['all']->accuracy ); ?>%</span>
							...
							<table cellspacing="0">
								<tbody>
									<tr>
										...
										<td width="5%" />
										<td align="left"><span><?php echo esc_html( $akismet_user->account_name ); ?></span>
										</td>
									</tr>
									<tr>
