...
<div class="product-info"
	data-current-product=<?php echo $this->productTextDomain; ?>
	data-current-product-slug=<?php echo $this->productSlug; ?>
	data-product-version=<?php echo $this->productVersion; ?>
	data-product-name="<?php echo $this->productName; ?>"
	...
	<div class="container">
		<div class="row product_header">
			...
			<div class="col-md-2 col-sm-2 col-xs-2 social_media_area">
				<div class="social-media-links">
					<a href="https://profiles.wordpress.org/flippercode/"
						target="_blank"><i class="fa fa-wordpress" aria-hidden="true"></i></a>
					<a href="https://www.facebook.com/flippercodepvtltd/"
						target="_blank"><i class="fa fa-facebook-official"
						aria-hidden="true"></i></a> <a
						href="http://twitter.com/wpflippercode" target="_blank"><i
						class="fa fa-twitter" aria-hidden="true"></i></a> <a
						href="https://www.linkedin.com/company/2737561" target="_blank"><i
						class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a
						href="https://plus.google.com/+Flippercode" target="_blank"><i
		...
		<div class="flexrow">
			<div class="header">
				<h1 style="width: 100%;">Features Present In Pro Version Of This
					Product</h1>
			</div>
			<div class="col-md-5">
				 <?php
			...
			?>
		          <div class="row">
					...
					<div class="col-md-10 product-feature">
						<a href="<?php echo $this->productSaleURL; ?>"
							class="bluebg likebutton glossy-move" target="_blank">See Full
							Features <i></i>
						</a>
					</div>
				</div>
			...
			if (! empty ( $this->productBanner )) {
				...
				<a href="<?php echo $this->productSaleURL; ?>" target="_blank"> <img
					src="<?php echo $this->productBanner; ?>"
...
<div class="srow">
	<div class="product-gallery">
		<p>
			Check out our other feature rich wordpress products crafted with
			technical expertise and patience. &nbsp;<input type="button"
				class="bluebg" id="hide_promotional_products"
				name="hide_promotional_products" value="Hide Me" />
		</p>
	</div>
	<div class="product-thumbs">
			...
			foreach ( $this->allProductsInfo as $key => $productInfo ) {
				...
				if ('push-notification' == $productInfo ['text-domain'] or 'automatic-updates' == $productInfo ['text-domain'] or 'store-locator' == $productInfo ['text-domain']) {
					continue;
			...
			<a href="<?php echo $productInfo['url']; ?>" class="l3 thumbnail"><img
				src="<?php echo $this->productImagePath.$productInfo['img']; ?>"
...
<?php
		...
		function setup_plugin_info($pluginInfo) {
			...
			$googlemap = array (
					'text-domain' => 'wp-google-map-gold',
					'img' => '1.png',
					'url' => 'http://www.flippercode.com/product/wp-google-map-pro/' 
			);
			$gmap_cf7 = array (
					'text-domain' => 'cf7-google-maps',
					'img' => '2.png',
					'url' => 'http://www.flippercode.com/product/cf7-google-maps/' 
			);
			$custom_css_js = array (
					'text-domain' => '',
					'img' => '3.png',
			...
			$layers_advance_gmap = array (
					'text-domain' => '',
					'img' => '4.png',
					'url' => 'http://www.flippercode.com/product/layers-advanced-google-maps/' 
			);
			$wp_meta_tags_optimisation = array (
					'text-domain' => '',
					'img' => '5.png',
					'url' => 'http://codecanyon.net/item/meta-tags-optimization-write-optimized-meta-tags/4915633' 
			);
			$overlaypro = array (
					'text-domain' => 'op_lang',
					'img' => '6.png',
					'url' => 'http://www.flippercode.com/product/wp-overlays-pro/' 
			);
			$was_this_helpful = array (
					'text-domain' => 'was-this-helpful-pro',
					'img' => '7.png',
					'url' => 'http://www.flippercode.com/product/was-this-helpful/' 
			);
			...
			$wp_custom_emails = array (
					'text-domain' => 'wp-custom-emails',
					'img' => '9.png',
					'url' => 'http://www.flippercode.com/product/wordpress-custom-emails/' 
			);
			$display_files = array (
					'text-domain' => 'wp-display-files',
					'img' => '10.png',
					'url' => 'http://www.flippercode.com/product/wp-display-files/' 
			);
			$wp_newsletter_pro = array (
					'text-domain' => '',
					'img' => '11.png',
					'url' => '' 
			);
			$wppostspro = array (
					'text-domain' => 'wp-posts-pro',
					'img' => '12.png',
					'url' => 'http://www.flippercode.com/product/wp-posts-pro/' 
			);
			$wpsecurityquestion = array (
					'text-domain' => 'wp-security-questions-pro',
					'img' => '13.png',
					'url' => 'http://www.flippercode.com/product/wp-security-questions/' 
			);
			$useravatar = array (
					'text-domain' => 'wp-user-avatar-pro',
					'img' => '14.png',
					'url' => 'http://www.flippercode.com/product/wp-user-avatar/' 
			);
			$pushnotification = array (
					'text-domain' => 'wp-push-notifications-pr',
					'img' => '15.png',
					'url' => 'http://codecanyon.net/item/wp-push-notifications-pro/16019774' 
			);
			$automaticUpdates = array (
					'text-domain' => 'wp-updates-pro',
					'img' => '16.png',
					'url' => 'http://codecanyon.net/item/automatic-updates-for-premium-plugins-themes/15948773' 
			);
			$storeLocator = array (
					'text-domain' => 'wc-store-locator-pro',
					'img' => '17.png',
					'url' => 'http://www.flippercode.com/product/wc-store-locator/' 
			);
			/*
...
<div class="purchase-verification-container">
	<div class="row brow">
		...
		<div class="col-md-10">
			<strong>Product Purchase Key</strong><br>You can find your product
			key by visiting<a target="_blank"
				href="http://www.codecanyon.net/downloads" class="purchasekey_link">
				Here </a>and click on "Downloads" and find "License certificate and
			purchase code(text)".
		</div>
	</div>
	<form class="purchase-verification-form"
		id="purchase-verification-form" name="purchase-verification-form"
		method="post" action="#">
		...
		<input type="text" id="purchase_code" name="purchase_code"
			class="form-control" placeholder="Enter Your Purchase Code" required>
		<div class="purchase-action">
			<input type="button" class="btn-primary"
				name="purchase-verification-btn" id="purchase-verification-btn"
				value="Verify Purchase" />
...
<form name="user-suggestion-form" id="user-suggestion-form" action="#"
	method="post">
	<textarea rows="5" name="user-suggestion" required id="user-suggestion"
		placeholder="Do you have any suggestions to improve this product ? We'd really like to hear and understand your much valuable suggestions any time."></textarea>
	<input type="button" class="blue submit-suggestion"
		name="submit-user-suggestion" id="submit-user-suggestion"
		name="submit-user-suggestion" value="Submit Suggestion">
	<div class="loader submitsuggestion">
		<i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i> <span
			class="sr-only">Loading...</span>
	</div>
	<input type="hidden" name="suggestion-for"
		value="<?php echo $this->productTextDomain; ?>">
