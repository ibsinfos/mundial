...
if (class_exists ( 'WP_List_Table_Helper' ) and ! class_exists ( 'wcjp_PHP_Table' )) {
	...
	global $wpdb;
	$columns = array (
			'data_title' => __ ( 'Title', WCJP_TEXT_DOMAIN ),
			'data_cond' => __ ( 'Apply Using', WCJP_TEXT_DOMAIN ),
			'status' => __ ( 'Status', WCJP_TEXT_DOMAIN ),
			'shortcode' => __ ( 'Shortcode', WCJP_TEXT_DOMAIN ),
			'tag_name' => __ ( 'Action/Filter', WCJP_TEXT_DOMAIN ) 
	);
	$sortable = array (
			'data_title',
			'data_cond' 
