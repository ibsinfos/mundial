...
class Importer {
	 ...
	 * Constructor method.
	 *
	 * @param array $importer_options
	 *        	Importer options.
	 * @param object $logger
	 *        	Logger object used in the importer.
	 */
	 ...
	 *        	path to xml file, file with WordPress export data.
	 */
	...
	public function import_content($import_file_path) {
		...
		add_filter ( 'wxr_importer.pre_process.post', array (
				$this,
				'new_ajax_request_maybe' 
		) );
	...
	public function new_ajax_request_maybe($data) {
		...
		if ($time > apply_filters ( 'pt-ocdi/time_for_one_ajax_call', 25 )) {
			...
			$log_added = Helpers::append_to_file ( __ ( 'New AJAX call!', 'pt-ocdi' ) . PHP_EOL . $message, $this->ocdi->get_log_file_path (), '' );
