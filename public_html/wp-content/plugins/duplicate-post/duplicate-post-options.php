...
<div class="wrap">
	...
	<div
		...
		<br /> <a href="https://duplicate-post.lopo.it/donate"><img
				...
				src="<?php echo plugins_url( 'donate.png', __FILE__ ); ?>"
...
global $wp_version;
	if (version_compare ( $wp_version, '4.7' ) >= 0) {
		?>
							...
							name="duplicate_post_show_bulkactions" value="1" <?php  if(get_option('duplicate_post_show_bulkactions') == 1) echo 'checked="checked"'; ?>"/>
