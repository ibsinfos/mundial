 ...
 *        	Optional, default to display. How to write the '&', defaults to '&amp;'.
 * @param string $draft
...
function duplicate_post_clone_post_link($link = null, $before = '', $after = '', $id = 0) {
	...
	$link = '<a class="post-clone-link" href="' . $url . '" title="' . esc_attr__ ( "Copy to a new draft", 'duplicate-post' ) . '">' . $link . '</a>';
 ...
 * @param string $output
 *        	Optional, default is Object. Either OBJECT, ARRAY_A, or ARRAY_N.
