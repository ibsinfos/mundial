...
<script type="text/javascript"
	src="<?php echo site_url(); ?>/wp-includes/js/jquery/jquery.js"></script>
<script type="text/javascript"
...
<body id="link" class="wp-core-ui"
	onload="document.body.style.display='';" style="display: none;">
	<div id="wpua-tabs">
		<ul>
		...
		<form name="wpUserAvatar" action="#">
			<div id="wpua">
				<p>
					...
					<select id="<?php esc_attr_e('wp_user_avatar_user'); ?>"
						name="<?php esc_attr_e('wp_user_avatar_user'); ?>">
						<option value=""></option>
            ...
            <?php endforeach; ?>
				...
				<p>
					...
					<select id="<?php esc_attr_e('wp_user_avatar_size'); ?>"
						name="<?php esc_attr_e('wp_user_avatar_size'); ?>">
						<option value=""></option>
				...
				<p id="<?php esc_attr_e('wp_user_avatar_size_number_section'); ?>">
					...
					<input type="text" size="8"
						id="<?php esc_attr_e('wp_user_avatar_size_number'); ?>"
						name="<?php esc_attr_e('wp_user_avatar_size'); ?>" value="" />
				</p>

				<p>
					<label for="<?php esc_attr_e('wp_user_avatar_align'); ?>"><strong><?php _e('Alignment','wp-user-avatar'); ?>:</strong></label>
					<select id="<?php esc_attr_e('wp_user_avatar_align'); ?>"
						name="<?php esc_attr_e('wp_user_avatar_align'); ?>">
						<option value=""></option>
				...
				<p>
					...
					<select id="<?php esc_attr_e('wp_user_avatar_link'); ?>"
						name="<?php esc_attr_e('wp_user_avatar_link'); ?>">
						<option value=""></option>
				...
				<p id="<?php esc_attr_e('wp_user_avatar_link_external_section'); ?>">
					...
					<input type="text" size="36"
						id="<?php esc_attr_e('wp_user_avatar_link_external'); ?>"
						name="<?php esc_attr_e('wp_user_avatar_link_external'); ?>"
						value="" />
				</p>
				...
				<p>
					...
					<input type="checkbox"
						id="<?php esc_attr_e('wp_user_avatar_target'); ?>"
						name="<?php esc_attr_e('wp_user_avatar_target'); ?>"
						value="_blank" /> <strong><?php _e('Open link in a new window','wp-user-avatar'); ?></strong>
				</p>

				<p>
					<label for="<?php esc_attr_e('wp_user_avatar_caption'); ?>"><strong><?php _e('Caption','wp-user-avatar'); ?>:</strong></label>
					<textarea cols="36" rows="2"
						id="<?php esc_attr_e('wp_user_avatar_caption'); ?>"
						name="<?php esc_attr_e('wp_user_avatar_size'); ?>"></textarea>
				</p>

				<div class="mceActionPanel">
					<input type="submit" id="insert" class="button-primary"
						name="insert" value="<?php _e('Insert into Post'); ?>"
						onclick="wpuaInsertAvatar();" />
				</div>
			</div>
			<div id="wpua-upload" style="display: none;">
				<p id="<?php esc_attr_e('wp_user_avatar_upload'); ?>">
					...
					<input type="text" size="36"
						id="<?php esc_attr_e('wp_user_avatar_upload'); ?>"
						name="<?php esc_attr_e('wp_user_avatar_upload'); ?>"
						value="<?php esc_attr_e('[avatar_upload]'); ?>"
						readonly="readonly" />
				</p>
				...
				<div class="mceActionPanel">
					<input type="submit" id="insert" class="button-primary"
						name="insert"
						value="<?php _e('Insert into Post','wp-user-avatar'); ?>"
						onclick="wpuaInsertAvatarUpload();" />
				</div>
			</div>
		</form>
	</div>
