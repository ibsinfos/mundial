...
<div class="wrap">
      ...
      <tr valign="top">
          ...
          <?php
              ...
              <label for="wp_user_avatar_tinymce">
                <input name="wp_user_avatar_tinymce" type="checkbox" id="wp_user_avatar_tinymce" value="1" ' . checked ( $wpua_tinymce, 1, 0 ) . ' />' . __ ( 'Add avatar button to Visual Editor', 'wp-user-avatar' ) . '
              </label>
            </fieldset>';
										$wpua_settings ['upload'] = '<fieldset>
              <label for="wp_user_avatar_allow_upload">
                <input name="wp_user_avatar_allow_upload" type="checkbox" id="wp_user_avatar_allow_upload" value="1" ' . checked ( $wpua_allow_upload, 1, 0 ) . ' />' . __ ( 'Allow Contributors & Subscribers to upload avatars', 'wp-user-avatar' ) . '
              </label>
            </fieldset>';
										$wpua_settings ['gravatar'] = '<fieldset>
              <label for="wp_user_avatar_disable_gravatar">
                <input name="wp_user_avatar_disable_gravatar" type="checkbox" id="wp_user_avatar_disable_gravatar" value="1" ' . checked ( $wpua_disable_gravatar, 1, 0 ) . ' />' . __ ( 'Disable Gravatar and use only local avatars', 'wp-user-avatar' ) . '
              </label>
            </fieldset>';
										/**
    ...
    <?php
        ...
        <table class="form-table">
          <tr valign="top">
            <th scope="row">
              <label for="wp_user_avatar_upload_size_limit">' . __ ( 'Upload Size Limit', 'wp-user-avatar' ) . ' ' . __ ( '(only for Contributors & Subscribers)', 'wp-user-avatar' ) . '
              </label>
            </th>
            <td>
              <fieldset>
              ...
              <fieldset>
                <label for="wp_user_avatar_edit_avatar">
                  <input name="wp_user_avatar_edit_avatar" type="checkbox" id="wp_user_avatar_edit_avatar" value="1" ' . checked ( $wpua_edit_avatar, 1, 0 ) . ' />' . __ ( 'Allow users to edit avatars', 'wp-user-avatar' ) . '
                </label>
              </fieldset>
              <fieldset>
                <label for="wp_user_avatar_resize_upload">
                  <input name="wp_user_avatar_resize_upload" type="checkbox" id="wp_user_avatar_resize_upload" value="1" ' . checked ( $wpua_resize_upload, 1, 0 ) . ' />' . __ ( 'Resize avatars on upload', 'wp-user-avatar' ) . '
                </label>
              </fieldset>
    ...
    <table class="form-table">
          ...
          <?php _e('Show Avatars','wp-user-avatar'); ?>
						...
						<tr valign="top" id="avatar-rating"
							<?php echo ((bool) $wpua_disable_gravatar == 1) ? 'style="display:none"' : ''?>>
							<th scope="row"><?php _e('Maximum Rating','wp-user-avatar'); ?></th>
							<td>
								<fieldset>
									<legend class="screen-reader-text">
										<span><?php _e('Maximum Rating','wp-user-avatar'); ?></span>
									</legend>
              <?php
														$ratings = array (
						...
						<tr valign="top">
							...
							<td class="defaultavatarpicker">
								<fieldset>
									<legend class="screen-reader-text">
										<span><?php _e('Default Avatar','wp-user-avatar'); ?></span>
									</legend>
			...
			<td>
				<div id="fc-sidebar">
					<div class="fc-box">
						...
						<p>
							<a target="_blank"
								href="http://codecanyon.net/item/wp-user-avatar-pro/15638832"><img
								width="500"
								src="<?php echo WPUA_URL.'images/wp-user-avatar-banner.png'; ?>" /></a>
						</p>
						<p>
							<em>Introducing awesome features to enhance user experience when
								they upload own avatar.</em>
						</p>
						<p>Pro features include webcam, custom folder, amazon s3 storage,
							dropbox storage, cropping and priority support.</p>
						<p>
							<a class="button button-primary button-large" target="_blank"
								href="http://codecanyon.net/item/wp-user-avatar-pro/15638832">Upgrade
								Now »</a>
						</p>
					</div>
					<div class="fc-box">
						...
						<p>
							Use the <a target="_blank"
								href="http://www.flippercode.com/forums">support forums</a> on
							flippercode.com.
						</p>
					</div>
					...
					<div class="fc-box">
						...
						<ul class="ul-square">
							<li><a target="_blank"
								href="http://www.flippercode.com/product/wp-user-avatar/">Upgrade
									to WP User Avatar Pro</a></li>
							<li><a target="_blank"
								href="https://wordpress.org/support/view/plugin-reviews/wp-user-avatar?rate=5#postform">Leave
									a ★★★★★ plugin review on WordPress.org</a></li>
							<li><a target="_blank"
								href="https://wordpress.org/plugins/wp-user-avatar/">Vote
									"works" on the WordPress.org plugin page</a></li>
						</ul>
					</div>
				</div>
			</td>
