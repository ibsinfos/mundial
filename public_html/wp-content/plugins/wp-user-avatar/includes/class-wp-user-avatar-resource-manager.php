...
class WP_User_Avatar_Resource_Manager {
	...
	/**
	 * Start buffering all generated output.
	 * We'll then do two things with the buffer
	...
	/**
	 * Removes the closing </html> tag from the output buffer.
	 * We'll then write our own closing tag
	 ...
	 * Manipulate and output the buffer
	 * 
	 * @since 1.9.5
	 */
	function shutdown() {
