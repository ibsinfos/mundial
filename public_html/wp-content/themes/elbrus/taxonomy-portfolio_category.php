...
$elbrus_portfolio_category_description = get_term_field ( 'description', $elbrus_portfolio_term->term_id, 'portfolio_category' );
				...
				if ($wp_query->have_posts ()) :
					...
					while ( $wp_query->have_posts () ) :
						...
						$elbrus_portfolio_linked_list_cats = elbrus_get_post_terms ( array (
						...
						if ($elbrus_portfolio_type == 'type_without_icons') :
							?>
									...
									<div
							class="<?php echo esc_attr($elbrus_add_class_port_col); ?> item <?php echo esc_attr($elbrus_portfolio_css_animation); ?> <?php echo esc_attr($elbrus_cat_slugs); ?>"
						 ...
						 <?phpelse :
							...
							if ($elbrus_portfolio_post_type == 'image') :
								...
								?>
															<li><a
												href="<?php echo esc_url($elbrus_portfolio_full_image_link); ?>"
												rel="prettyPhoto[pp_gal_<?php echo esc_attr(get_the_id());?>]"><span
								...
								if ($elbrus_portfolio_video_href != '') :
									...
									?>
												...
												rel="prettyPhoto[pp_video_<?php echo esc_attr(get_the_id());?>]"><span
													class="icon icon-Media"></span></a></li>
							...
							?>
															<li><a
												href="<?php echo esc_url( get_permalink( get_the_ID() ) ); ?>"><span
													class="icon icon-Info"></span></a></li>
														<?php
