...
<li <?php comment_class('media'); ?>
	...
	?>
				<div class="avatar">
				<img alt="<?php echo get_comment_author(); ?>"
					src="<?php echo !empty($src) ? esc_url($src) : esc_url(get_template_directory_uri() . '/img/nouser.jpg'); ?>">
			</div>
		</div>

		<div class="media-body">
			<div class="comment-title">
				<span class="name"><?php echo get_comment_author_link(); ?></span> <span><?php echo ' ' . esc_html__( 'says', 'elbrus' ) . ' '; ?></span>
...
function elbrus_num_pagination($pages = '', $range = 2) {
	...
	if (1 != $pages) {
		...
		if ($paged > 1 && $showitems < $pages)
			echo '<li><a href="' . esc_url ( get_pagenum_link ( esc_html ( $paged ) - 1 ) ) . '"><i class="fa-chevron-left"></i></a></li>';
		...
		if ($paged < $pages && $showitems < $pages)
			echo '<li><a href="' . esc_url ( get_pagenum_link ( esc_html ( $paged ) + 1 ) ) . '"><i class="fa-chevron-right"></i></a></li>';
