...
function elbrus_integrateWithVC() {
	...
	$jarallax = array (
			array (
					'type' => 'attach_image',
					'heading' => esc_html__ ( "Background Image", 'elbrus' ),
					'param_name' => 'bgimage',
					'value' => '',
					'description' => esc_html__ ( "Background image ", 'elbrus' ),
					'group' => esc_html__ ( 'Row Options', 'elbrus' ) 
			),
			array (
					'type' => 'dropdown',
					'heading' => esc_html__ ( "Background Style", 'elbrus' ),
					'param_name' => 'bgstyle',
					'value' => array (
							esc_html__ ( "Default", 'elbrus' ) => '',
							esc_html__ ( "Parallax", 'elbrus' ) => 'jarallax',
							esc_html__ ( "Fixed", 'elbrus' ) => 'attachment' 
					),
					'description' => esc_html__ ( "Image background style", 'elbrus' ),
					'group' => esc_html__ ( 'Row Options', 'elbrus' ) 
			),
			array (
					'type' => 'dropdown',
					'heading' => esc_html__ ( "Stretch Content", 'elbrus' ),
					'param_name' => 'jarstretch',
					'value' => array (
							'No',
							'Yes' 
					),
					'description' => esc_html__ ( 'Select stretching options for content.', 'elbrus' ),
					'dependency' => array (
							'element' => 'bgstyle',
							'value' => 'jarallax' 
					),
			...
			array (
					"type" => "textfield",
					"heading" => esc_html__ ( "Speed", 'elbrus' ),
					"param_name" => "jarspeed",
					"value" => '',
					"description" => esc_html__ ( "Provide numbers from -1.0 to 2.0", 'elbrus' ),
					'dependency' => array (
							'element' => 'bgstyle',
							'value' => 'jarallax' 
					),
			...
			array (
					'type' => 'param_group',
					'value' => '',
					'heading' => esc_html__ ( 'Gradient Overlay', 'elbrus' ),
					'param_name' => 'gradient_colors',
					'params' => array (
							array (
									'type' => 'colorpicker',
									'value' => '',
									'heading' => esc_html__ ( 'Color For Gradient', 'elbrus' ),
									'param_name' => 'gradient_color' 
							) 
					),
					'group' => esc_html__ ( 'Gradient Overlay', 'elbrus' ) 
			),
			array (
					'type' => 'dropdown',
					'heading' => esc_html__ ( 'Direction', 'elbrus' ),
					'param_name' => 'gradient_direction',
					'value' => array (
							esc_html__ ( 'To Right ', 'elbrus' ) . html_entity_decode ( '&rarr;' ) => 'to right',
							esc_html__ ( 'To Left ', 'elbrus' ) . html_entity_decode ( '&larr;' ) => 'to left',
							esc_html__ ( 'To Bottom ', 'elbrus' ) . html_entity_decode ( '&darr;' ) => 'to bottom',
							esc_html__ ( 'To Top ', 'elbrus' ) . html_entity_decode ( '&uarr;' ) => 'to top',
							esc_html__ ( 'To Bottom Right ', 'elbrus' ) . html_entity_decode ( '&#8600;' ) => 'to bottom right',
							esc_html__ ( 'To Bottom Left ', 'elbrus' ) . html_entity_decode ( '&#8601;' ) => 'to bottom left',
							esc_html__ ( 'To Top Right ', 'elbrus' ) . html_entity_decode ( '&#8599;' ) => 'to top right',
							esc_html__ ( 'To Top Left ', 'elbrus' ) . html_entity_decode ( '&#8598;' ) => 'to top left',
							esc_html__ ( 'Angle ', 'elbrus' ) . html_entity_decode ( '&#10227;' ) => 'angle' 
					),
					'description' => '',
					'group' => esc_html__ ( 'Gradient Overlay', 'elbrus' ) 
			),
			array (
					'type' => 'textfield',
					'heading' => esc_html__ ( 'Angle Direction', 'elbrus' ),
					'param_name' => 'gradient_angle',
					'value' => "90",
					'description' => esc_html__ ( 'Values -360 - 360', 'elbrus' ),
					'dependency' => array (
			...
			array (
					'type' => 'textfield',
					'heading' => esc_html__ ( 'Opacity', 'elbrus' ),
					'param_name' => 'gradient_opacity',
					'value' => "1",
					'description' => esc_html__ ( 'Values 0.01 - 0.99', 'elbrus' ),
					'group' => esc_html__ ( 'Gradient Overlay', 'elbrus' ) 
			) 
	)
	;
	...
	if (! function_exists ( 'fil_init' )) {
		...
		$attributes = array_merge ( $attributes1, elbrus_get_vc_icons ( $vc_icons_data ), $attributes2, $jarallax, $attributes3 );
	}
	...
	), $add_css_animation, elbrus_get_vc_icons ( $vc_icons_data ) );
	...
	vc_map ( array (
			...
			'js_view' => 'VcColumnView' 
	) // must be added for all Containers ( or should be extended in js ). VC Dev team
 );
