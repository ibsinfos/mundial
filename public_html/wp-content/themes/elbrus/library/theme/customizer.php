...
.header .navbar .navbar-nav .open>a, .header .navbar .navbar-nav .open>a:focus,
...
.wrap-inside-nav .inside-col .inside-nav li a:hover, .wrap-inside-nav .inside-col .inside-nav li a:active:hover,
...
.sidebar .widget_archive ul li a:before, .sidebar .widget_categories ul li a:before,
	.sidebar .widget_pages ul li a:before, .sidebar .widget_nav_menu ul li a:before,
...
.elbrus-contact-form input[type="submit"]:hover, .elbrus-contact-form input[type="submit"]:focus,
	.elbrus-contact-form input[type="submit"]:active:focus {
	background: <?php echo esc_attr($ elbrus_color_darker); ?>;
	border-color: <?php echo esc_attr($ elbrus_color_darker);
		?>;
}
...
.blog-content-section .left-column .wrap-blog-post .list-socials li a:hover
	...
	background: <?php echo esc_attr($ elbrus_main_color); ?>;
	border-color: <?php echo esc_attr($ elbrus_main_color); ?>;
	-moz-box-shadow: 0 0 1px<?php echo esc_attr($ elbrus_color_darker); ?>
	inset;
	-webkit-box-shadow: 0 0 1px<?php echo esc_attr($ elbrus_color_darker);
		?> inset;
	box-shadow: 0 0 1px<?php echo esc_attr($ elbrus_color_darker);
		?>
	inset;
}
...
.wrap-pagination .pagination-list li a:hover {
	-moz-box-shadow: 0 0 0 1px<?php echo esc_attr($ elbrus_main_color); ?>
	inset;
	-webkit-box-shadow: 0 0 0 1px<?php echo esc_attr($ elbrus_main_color);
		?> inset;
...
body .yp-demo-link:hover, body .yp-demo-link:active, body .yp-demo-link:focus
	{
	background: <?php echo esc_attr($ elbrus_color_darker);
		?>
	!
...
if (
		...
		elbrus_get_option ( 'style_settings_custom_css' ) != 
