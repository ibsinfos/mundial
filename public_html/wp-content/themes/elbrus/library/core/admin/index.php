<?php
	...
	function elbrus_load_custom_wp_admin_style()
	{
		...
		wp_register_script( 'elbrus_custom_wp_admin_script', get_template_directory_uri() . '/js/custom-admin.js', array( 'jquery' ) );
		wp_localize_script( 'elbrus_custom_wp_admin_script', 'meta_image',
				array(
		...
		wp_enqueue_script( 'elbrus-color', get_template_directory_uri() . '/js/custom-script.js', array( 'wp-color-picker' ), false, true );
