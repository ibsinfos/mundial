...
function elbrus_customize_portfolio_tab($wp_customize, $theme_name) {
	$wp_customize->add_panel ( 'elbrus_portfolio_settings', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_trumb_width', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_trumb_height', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_type', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_perrow', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_perpage', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_sidebar_type', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_sidebar_content', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_loadmore', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_related_show', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_related_title', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_related_desc', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_share', array (
	...
	$wp_customize->add_control ( 'elbrus_portfolio_settings_link_to_all', array (
