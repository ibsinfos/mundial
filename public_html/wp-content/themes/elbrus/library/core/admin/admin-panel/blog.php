...
function elbrus_customize_blog_tab($wp_customize, $theme_name) {
	...
	$wp_customize->add_control ( 'elbrus_blog_settings_sidebar_type', array (
	...
	$wp_customize->add_control ( 'elbrus_blog_settings_sidebar_content', array (
	...
	$wp_customize->add_control ( 'elbrus_blog_settings_readmore', array (
	...
	$wp_customize->add_control ( 'elbrus_blog_show_share', array (
	...
	$wp_customize->add_control ( 'elbrus_blog_show_date', array (
	...
	$wp_customize->add_control ( 'elbrus_blog_show_author', array (
	...
	$wp_customize->add_control ( 'elbrus_blog_show_tags', array (
