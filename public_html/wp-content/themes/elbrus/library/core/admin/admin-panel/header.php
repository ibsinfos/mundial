...
function elbrus_customize_header_tab($wp_customize, $theme_name) {
	...
	$wp_customize->add_control ( new WP_Customize_Image_Control ( $wp_customize, 'elbrus_header_settings_headerimage', array (
	...
	$wp_customize->add_control ( 'elbrus_header_settings_headerimage_overlay', array (
	...
	$wp_customize->add_control ( 'elbrus_header_settings_headerimage_opacity', array (
	...
	$wp_customize->add_setting ( 'elbrus_header_settings_minicart', array (
			'default' => 'off',
			'transport' => 'refresh',
			'sanitize_callback' => 'elbrus_sanitize_onoff' 
	) );
	
	$wp_customize->add_control ( 'elbrus_header_settings_minicart', array (
			'label' => esc_html__ ( 'On/off header minicart', 'elbrus' ),
			'section' => 'elbrus_header_settings',
			'settings' => 'elbrus_header_settings_minicart',
			'type' => 'select',
			'choices' => array (
					'on' => esc_html__ ( 'On', 'elbrus' ),
					'off' => esc_html__ ( 'Off', 'elbrus' ) 
	...
	$wp_customize->add_control ( 'elbrus_header_settings_subtitle', array (
	...
	$wp_customize->add_control ( 'elbrus_header_settings_title_single_post', array (
	...
	$wp_customize->add_control ( 'elbrus_header_settings_title_all_posts', array (
	...
	$wp_customize->add_control ( 'elbrus_header_settings_title_single_portfolio', array (
	...
	$wp_customize->add_control ( 'elbrus_header_settings_title_search_results', array (
