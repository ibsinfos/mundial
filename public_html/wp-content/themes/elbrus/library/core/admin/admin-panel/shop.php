...
function elbrus_customize_shop_tab($wp_customize, $theme_name) {
	...
	$wp_customize->add_control ( 'elbrus_shop_settings_global_product', array (
	...
	$wp_customize->add_control ( 'elbrus_shop_settings_sidebar_type', array (
	...
	$wp_customize->add_control ( 'elbrus_shop_settings_sidebar_content', array (
