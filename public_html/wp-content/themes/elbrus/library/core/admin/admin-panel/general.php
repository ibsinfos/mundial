...
function elbrus_customize_general_tab($wp_customize, $theme_name) {
	...
	$wp_customize->add_control ( new WP_Customize_Image_Control ( $wp_customize, 'elbrus_general_settings_logo', array (
	...
	$wp_customize->add_control ( new WP_Customize_Image_Control ( $wp_customize, 'elbrus_general_settings_logo_inverse', array (
	...
	$wp_customize->add_control ( new WP_Customize_Image_Control ( $wp_customize, 'elbrus_general_settings_logo_mobile', array (
	...
	$wp_customize->add_control ( 'elbrus_general_settings_loader', array (
	...
	$wp_customize->add_control ( 'elbrus_general_settings_css_live_editor', array (
