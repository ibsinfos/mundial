...
function elbrus_customize_css_animation_tab($wp_customize, $theme_name) {
	...
	$wp_customize->add_control ( 'elbrus_css_animation_settings_header_title', array (
	...
	$wp_customize->add_control ( 'elbrus_css_animation_settings_blog', array (
	...
	$wp_customize->add_control ( 'elbrus_css_animation_settings_sidebar', array (
	...
	$wp_customize->add_control ( 'elbrus_css_animation_settings_portfolio', array (
