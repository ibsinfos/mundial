...
function elbrus_layout_side() {
	add_meta_box(
			'elbrus_layout_side',
			esc_html__('Page Settings', 'elbrus'),
			'elbrus_layout_side_content',
...
function elbrus_page_layout_options(){
    ...
    <p><strong><?php echo esc_html__('Header Icon Class', 'elbrus')?></strong></p>
    <ul>

        <li>
            <input type="text" name="pix_page_header_icon" value="<?php echo esc_attr($selected_header_icon)?>" />
        </li>
    </ul>
...
function elbrus_woo_layout(){
	...
	<p><strong><?php echo esc_html__('Woocommerce Layout', 'elbrus')?></strong></p>

	<select class="rwmb-select" name="pix_woo_layout" id="pix_woo_layout" size="0">
		<option value="" <?php if ($selected_woo_layout == ''):?>selected="selected"<?php endif?>><?php echo esc_html__('Global', 'elbrus')?></option>
		<option value="default" <?php if ($selected_woo_layout == 'default'):?>selected="selected"<?php endif?>><?php echo esc_html__('Default', 'elbrus')?></option>
		<option value="hover" <?php if ($selected_woo_layout == 'hover'):?>selected="selected"<?php endif?>><?php echo esc_html__('Hover Info', 'elbrus')?></option>
	</select>

	<p><strong><?php echo esc_html__('Product Display', 'elbrus')?></strong></p>

	<select class="rwmb-select" name="pix_woo_product_display" id="pix_woo_product_display" size="0">
		<option value="" <?php if ($selected_product_display == ''):?>selected="selected"<?php endif?>><?php echo esc_html__('Global', 'elbrus')?></option>
		<option value="default" <?php if ($selected_product_display == 'default'):?>selected="selected"<?php endif?>><?php echo esc_html__('Default', 'elbrus')?></option>
		<option value="stretch" <?php if ($selected_product_display == 'stretch'):?>selected="selected"<?php endif?>><?php echo esc_html__('Cell Stretch', 'elbrus')?></option>
	</select>
