...
<div id="comments"
	class="comments <?php echo esc_attr($elbrus_blog_css_animation); ?>">
	<div class="row">
		<div class="col-md-12">
...
<div
	class="elbrus-comment-form <?php echo esc_attr($elbrus_blog_css_animation); ?>">
	...
	$fields = array (
			'author' => '<div class="row"><div class="col-md-6"><div class="form-group">' . '<input id="author" class="form-control" name="author" type="text" placeholder="' . esc_html__ ( 'YOUR NAME', 'elbrus' ) . ($req ? ' *' : '') . '" value="' . esc_attr ( $commenter ['comment_author'] ) . '" size="30" autocomplete="on" tabindex="2" ' . $aria_req . $html_req . ' /></div></div>',
			'email' => '<div class="col-md-6"><div class="form-group">' . '<input id="email" class="form-control" name="email" type="text" placeholder="' . esc_html__ ( 'YOUR E-MAIL', 'elbrus' ) . ($req ? ' *' : '') . '" value="' . esc_attr ( $commenter ['comment_author_email'] ) . '" size="30" autocomplete="on" tabindex="3" ' . $aria_req . $html_req . ' /></div></div>',
			'url' => '<div class="col-md-6"><div class="form-group">' . '<input id="url" class="form-control" name="url" type="text" placeholder="' . esc_html__ ( 'YOUR WEBSITE', 'elbrus' ) . '" value="' . esc_attr ( $commenter ['comment_author_url'] ) . '" size="30" autocomplete="on" tabindex="4"' . $aria_req . ' /></div></div></div>' 
	);
