...
<section class="page-section">
	<div class="container">
		<div class="row">
			...
			<div
				class="<?php if ( $elbrus_layout == 1 ) : ?>col-lg-12 col-md-12<?php else : ?>col-lg-9 col-md-8 left-column sidebar-type-<?php echo esc_attr($elbrus_layout); ?><?php endif; ?> col-sm-12 col-xs-12">
