...
<div id="carousel-example-generic-<?php esc_attr( the_ID() ); ?>"
	...
	<a class="left carousel-control"
		href="#carousel-example-generic-<?php esc_attr( the_ID() ); ?>"
...
<?php elseif ($gallery && $gallery != '' && count ( $gallery ) == 1 || $attachment && count ( $attachment ) == 1) :
	?>
