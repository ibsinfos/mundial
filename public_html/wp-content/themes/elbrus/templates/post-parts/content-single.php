...
<div id="post-<?php esc_attr( the_ID() ); ?>"
	...
	<div class="wrap-post-description">
		...
		<a class="post-avatar"
			href="<?php esc_url( the_author_meta( 'user_url' ) ); ?>"><img
			class="" src="<?php echo esc_url($elbrus_src); ?>"
			alt="<?php esc_attr( the_author_meta( 'display_name' ) ); ?>"></a>
		<?php endif; ?>
		...
		<div class="meta <?php echo esc_attr($elbrus_add_meta_class); ?>">
			...
			<div class="meta-item">
				<span class="icon icon-Agenda"></span><?php echo get_the_date(); ?></div>
			<?php endif; ?>
