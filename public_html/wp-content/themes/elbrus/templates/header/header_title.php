...
$elbrus_pix_icon_class = get_post_meta ( $elbrus_pix_page_id, 'pix_page_header_icon', true ) ? '<div class="header-icon"><span class="icon ' . esc_attr ( get_post_meta ( $elbrus_pix_page_id, 'pix_page_header_icon', true ) ) . '"></span></div>' : '';
...
?>
<div
	class="header-container <?php echo esc_attr($elbrus_header_title_css_animation); ?>">
	<div class="header-title">
		<?php echo wp_kses_post($elbrus_pix_icon_class); ?>
		<div class="title">
			<?php
