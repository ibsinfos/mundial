<?php
$elbrus_header_image = elbrus_get_option ( 'header_settings_headerimage' ) ? elbrus_get_option ( 'header_settings_headerimage' ) : get_template_directory_uri () . '/img/sections/home-top-background.jpg';
?>
<section class="top-header blog-header with-bottom-effect transparent-effect" style="background-image: url(
	...
	if (is_page ()) :
		...
		<?php elseif (! empty ( $elbrus_header_image )) :
	...
	?>
	<?php if ( elbrus_get_option( 'header_settings_headerimage_overlay', 'on' ) == 'on' ) : ?>
