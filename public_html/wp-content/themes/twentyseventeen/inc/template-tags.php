...
if (! function_exists ( 'twentyseventeen_posted_on' )) :
	...
	function twentyseventeen_posted_on() {
		...
		__ ( 'by %s', 'twentyseventeen' ), '<span class="author vcard"><a class="url fn n" href="' . esc_url ( get_author_posts_url ( get_the_author_meta ( 'ID' ) ) ) . '">' . get_the_author () . '</a></span>' );
...
if (! function_exists ( 'twentyseventeen_time_link' )) :
	...
	function twentyseventeen_time_link() {
		...
		__ ( '<span class="screen-reader-text">Posted on</span> %s', 'twentyseventeen' ), '<a href="' . esc_url ( get_permalink () ) . '" rel="bookmark">' . $time_string . '</a>' );
	}
...
if (! function_exists ( 'twentyseventeen_edit_link' )) :
	...
	function twentyseventeen_edit_link() {
		$link = edit_post_link ( sprintf(
			/* translators: %s: Name of current post */
			__ ( 'Edit<span class="screen-reader-text"> "%s"</span>', 'twentyseventeen' ), get_the_title () ), '<span class="edit-link">', '</span>' );
 ...
 *
 * @param $partial WP_Customize_Partial
 *        	Partial associated with a selective refresh request.
 * @param $id integer
 *        	Front page section to display.
 */
